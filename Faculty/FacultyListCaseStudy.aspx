<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="FacultyListCaseStudy.aspx.cs" Inherits="Faculty_FacultyListCaseStudy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="Server">
    
   <script language="javascript" type="text/javascript">
       function openPopuppage(asgnid, uid) {
           window.open("../Admin/CaseStudyFinalAnswerSheet.aspx?CaseStudyType=Manual" + "&CSId=" + asgnid + "&uid=" + uid + "", "Info", "status=1, width=700, height=450, top=200, left=300");
...
<section class="fullwidth banner-color">
    <h1 class="heading-color">List Of Case Study</h1> 
    <div class="breadcrumbs">
		<ul class="clearfix">
        <li><a href="FacultyPanel.aspx"><font color="#fff">Faculty Panel</font></a></li>
       <li class="active">List Of Case Study</li>
		</ul>
	</div>
    </section>
...
<div class="row">
     ...
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                        
      <asp:DropDownList ID="ddlListAssignmentSet" runat="server" AutoPostBack="true" ToolTip="Assignment Code" Width="100%" CssClass="input-block-level" >
                                                                    </asp:DropDownList> 
                                                                    </div>
                         <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">  
         ...
         <div class="row">
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                Assignment Assigned to <%=Session["username"].ToString() %>
                 </div>
         </div>
                  <div class="row">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center" style="overflow:auto; height:600px">
                 
                 <asp:GridView ID="GrdAssignment" AutoGenerateColumns="false" runat="server" DataKeyNames="CSId"
                                                    Width="100%" AllowPaging="True" PageSize="10" CssClass="table" OnRowDataBound="GrdAssignment_RowDataBound">
                                                    ...
                                                    <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Case Study Type" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="15%">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="lnkAssignmentType" runat="server" Text='<%# Eval("CaseStudyType") %>'></asp:LinkButton>
                                                                            
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                       <asp:TemplateField HeaderText="Case Study Code" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="15%" >
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblasgncode" Text='<%# Eval("CScode") %>' runat="server" ></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="PaperTitle" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="20%"  >
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="hdnAssignmentType" Value='<%# Eval("CaseStudyType") %>' runat="server" ></asp:HiddenField>
                                                                <asp:HiddenField ID="hdnAsgnid" runat="server" Value='<%#Eval("CSId") %>' />
                                                                ...
                                                                <asp:HiddenField ID="hdnmanualAssignAssignment" runat="server" Value='<%#Eval("manualAssignCaseStudy") %>' />
                                                                <asp:HiddenField ID="hdnsubmiitedAssignment" runat="server" Value='<%#Eval("submiitedCaseStudy") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                             ...
                                                             <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Left">
                                                                ...
                                                                <asp:TemplateField ItemStyle-HorizontalAlign="Left"  HeaderText="Answer Sheet">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:LinkButton ID="lnkbtndownload" runat="server" Visible="false" >Answer Sheet 
                                                                        Manual </asp:LinkButton>&nbsp|&nbsp;
                                                                        <asp:LinkButton ID="lnkSubmitMarkformanual" OnClientClick=<%# "openPopuppage(" + Eval("CSID") + ",'" + Eval("Userid") + "')" %> runat="server" Visible="false" >Submit Marks </asp:LinkButton>
