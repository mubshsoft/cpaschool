<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="AssignmentInstruction.aspx.cs" Inherits="Faculty_AssignmentInstruction" EnableEventValidation="false" %>
...
input[type=checkbox], input[type=radio] {
   ...
   <section class="fullwidth banner-color">
    <h1 class="heading-color">Answer Sheet</h1> 
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr align="left" valign="top">
                                            ...
                                            <td align="center">
                                                <asp:DataList ID="dlstanswers" runat="server" Width="100%" 
                                                    ...
                                                    <ItemTemplate>
                                                        <table width="100%" class="style15" align="center">
                                                            <tr>
                                                            ...
                                                            <tr id="trRow3" runat="server">
                                                                ...
                                                                <td width="75%" align="left">
                                                                    ...
                                                                    <asp:TextBox ID="txtMarkscored" runat="server" Visible="false" cssclass="form-control" ToolTip="Enter Marks" Text='<%#Eval("MarkGivenByFaculty") %>'  />
                                                            ...
                                                            <%--<td  style="border: thin solid #000000"> &nbsp;</td>--%>
                                                                <td>
                                                                <asp:TextBox ID="txtfeedback" runat="server" cssclass="form-control" TextMode="MultiLine" Rows="5" Columns="5"  Text='<%#Eval("Feedback") %>' ToolTip='<%#Eval("questionid") %>' ></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table width="100%" class="style15" align="center">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="75%" align="left">
                                                                    ...
                                                                    <asp:TextBox ID="txtSubMarkscored" runat="server" cssclass="form-control" ToolTip="Enter Marks" Text='<%#Eval("MarkGivenByFaculty") %>'  />
                                        ...
                                        <tr align="left" valign="top">
                                            ...
                                            <td align="center" >
                                                ...
                                                <asp:Button ID="btnSave" runat="server" cssclass="btn btn-success" Text="Add Comment" OnClick="btnSave_Click" />
                                            </td>
                                            <td>
                                                &nbsp;
