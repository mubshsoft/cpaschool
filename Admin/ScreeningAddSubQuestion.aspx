<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScreeningAddSubQuestion.aspx.cs"
    Inherits="ScreeningAddSubQuestion" %>
...
<head id="Head1" runat="server">
    ...
    <title>Screening Sub Option</title>
                                        ...
                                        <div class="frame" style="width:701px">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="50%" align="right" style="padding-right: 10px">
                                                                    <strong class="style9"><a href="adminlogin.aspx"><font color="#4b4b4b">Back To Admin
                                                                        Panel</font></a></strong>&nbsp; <strong class="style9_sec">
                                                    ...
                                                    <td height="100%" class="style5" align="center" style="padding-top: 0px; padding-bottom: 20px;">
                                                        <table width="550px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="400px" align="left" class="style9_sec">
                                                                    <asp:TextBox ID="txtquestionNo" runat="server" Width="120px" TabIndex="1" CssClass="style11"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right" class="style9_sec" style="padding-right: 5PX;" width="150px">
                                                                    &nbsp;</td>
                                                                <td align="left" class="style9_sec" width="400px">
                                                                    <nobr>
                                                                    <asp:RequiredFieldValidator ID="rqdSurveyName" runat="server" 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="350px" align="left" class="style9_sec">
                                                                    <asp:DropDownList ID="ddlQuestionType" runat="server" AutoPostBack="true" CssClass="DropDownStyle11"
                                                                        TabIndex="2" Width="125px" OnSelectedIndexChanged="ddlQuestionType_SelectedIndexChanged">
                                                            ...
                                                            <tr>
                                                                <td align="right" class="style9_sec" style="padding-right: 5PX;" width="150px">
                                                                    &nbsp;</td>
                                                                <td align="left" class="style9_sec" width="350px">
                                                                    &nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td width="150px" align="right" style="padding-right: 5PX;" class="style5" valign="top">
                                                                    Question :
                                                                </td>
                                                                <td width="350px" align="left" class="style9_sec">
                                                                    <asp:TextBox ID="txtQuestion" runat="server" TextMode="MultiLine" Width="350px" TabIndex="3"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                <td width="150px" align="right" style="padding-right: 5PX;" class="style5">
                                                            ...
                                                            <tr>
                                                                <td width="150px" align="right" style="padding-right: 5PX" class="style9_sec">
                                                                    &nbsp;
                                                                </td>
                                                                <td width="350px" align="left">
                                                                    &nbsp;
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="350px" align="left" valign="middle">
                                                                    ...
                                                                    <asp:ImageButton ID="btnBack" runat="server" ImageUrl="~/Images/back_button.jpg"
                                                ...
                                                <tr align="left" valign="top">
                                                    ...
                                                    <td align="center">
                                                        <asp:GridView ID="gvQuestionList" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                                                            DataKeyNames="QuestionId" HeaderStyle-BackColor="#E4E4E4" HeaderStyle-Font-Bold="true"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Question No.">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="QuesNo" runat="server" CssClass="left_padding" Text='<%#DataBinder.Eval(Container.DataItem, "QuesNo")%>'></asp:Label>
                                                                        &nbsp;
                                                                    </ItemTemplate>
                                                                    <EditItemTemplate>
                                                                        <asp:TextBox ID="txtQuestionNo" runat="server" MaxLength="100" Text='<%# Bind("QuesNo") %>'></asp:TextBox>
                                                                    </EditItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Question">
                                                                    <ItemStyle HorizontalAlign="Left" Width="300px" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblName" runat="server" CssClass="left_padding" Text='<%#DataBinder.Eval(Container.DataItem, "QuestionText")%>'></asp:Label>
                                                                        &nbsp;
                                                                    </ItemTemplate>
                                                                    <EditItemTemplate>
                                                                        <asp:HiddenField ID="hdnDeleteQuestionId" runat="server" Value='<%#DataBinder.Eval(Container.DataItem, "SubQuestionId")%>' />
                                                                ...
                                                                <asp:TemplateField HeaderText="Answer">
                                                                    <ItemStyle HorizontalAlign="Left" Width="300px" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblAnswer" runat="server" CssClass="left_padding" Text='<%#DataBinder.Eval(Container.DataItem, "Answer")%>'></asp:Label>
                                                                        &nbsp;
                                                                    </ItemTemplate>
                                                                    <EditItemTemplate>
                                                                ...
                                                                <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:HiddenField ID="hdnQuestionId" runat="server" Value='<%#DataBinder.Eval(Container.DataItem, "SubQuestionId")%>' />
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemStyle HorizontalAlign="center" Width="75px" />
                                                                    <ItemTemplate>
                                                                        <asp:HiddenField ID="hdnAddQuestionId" runat="server" Value='<%#DataBinder.Eval(Container.DataItem, "SubQuestionId")%>' />
