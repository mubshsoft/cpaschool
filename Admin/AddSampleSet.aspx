<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true"
        ...
        <section class="container main m-tb">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                 <ContentTemplate>
                  ...
                  <asp:TextBox ID="txtSamplecode" runat="server" ToolTip="Sample Code" placeholder="Sample Code" CssClass="form-control"></asp:TextBox>
                  ...
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" Display="Dynamic" ControlToValidate="txtTimeAllowted" ErrorMessage="<br>Please enter numeric values" ValidationExpression="(^[0-9]*\d*\d{1}?\d*)$"></asp:RegularExpressionValidator>
                    ...
                    <div class="user-info media box" style="background-color:#fff;">
                                                                        ...
                                                                        <div class="row" >
                                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlcoursefillter" runat="server" AutoPostBack="True" CssClass="form-control" ToolTip="Course"
                                                                                                    OnSelectedIndexChanged="ddlcoursefillter_SelectedIndexChanged">
                                                                                                </asp:DropDownList></div>
                                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlyear" runat="server" AutoPostBack="True" CssClass="form-control" ToolTip="Year"
