<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="SampleAddOption.aspx.cs" Inherits="Admin_SampleAddOption" Title="Add Option" %>
    ...
    <section class="container main m-tb">
                <div class="row">
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <asp:DropDownList ID="ddlOptionType" runat="server" CssClass="form-control" TabIndex="2" >
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <asp:TextBox ID="txtoption" runat="server" TabIndex="3" CssClass="form-control"></asp:TextBox><asp:LinkButton ID="lnkbtnans" runat="server" onclick="lnkbtnans_Click">Click here add answer as option</asp:LinkButton>
