<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="SampleSelectSection.aspx.cs" Inherits="Admin_SampleSelectSection" Title="Section Info" %>
    ...
    <section class="container main m-tb">
     <div class="user-info media box" style="background-color:#fff;">
                <div class="row">
                 ...
                 <div class="row">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtNoofSection" ToolTip="No. of Section" placeholder="No. of Section" CssClass="form-control" runat="server"></asp:TextBox></div>
                 </div>                                       
