<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="AddAssessmentsOption.aspx.cs" Inherits="Admin_AddAssessmentsOption" %>
...
<section class="fullwidth banner-color">
  ...
  <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
      <asp:DropDownList ID="ddlOptionType" runat="server" TabIndex="2" CssClass="form-control" ToolTip="Option Type" >
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                                                              
      <asp:TextBox ID="txtoption" runat="server" TabIndex="3" CssClass="form-control" ToolTip="Add Option" PlaceHolder="Add Option"></asp:TextBox>
