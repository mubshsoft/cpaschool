<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="AssignmentActivateExam.aspx.cs" Inherits="Admin_AssignmentActivateAssignment" Title="Use Existing Assignment" %>
...
<section class="fullwidth banner-color">
    ...
    <asp:DropDownList ID="ddlAssignmentset" runat="server" ToolTip="Assignment Set" placeholder="Assignment Set" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlAssignmentset_SelectedIndexChanged">
                                                                    </asp:DropDownList>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
 <asp:DropDownList ID="ddlbatch" runat="server" ToolTip="Batch Code" CssClass="form-control"></asp:DropDownList>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:TextBox ID="txtDeactivateDate" runat="server" ToolTip="Deactivation Date" placeholder="Deactivation Date" CssClass="form-control"></asp:TextBox>
    ...
    <asp:Label ID="lblDeactivateDate" runat="server" Text="" ForeColor="Red"></asp:Label>
    </div>
