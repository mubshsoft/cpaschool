<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="ScreeningAddQuestion.aspx.cs" Inherits="Admin_ScreeningAddQuestion" Title="Add Question" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
       ...
       <asp:DropDownList ID="ddlQuestionType" runat="server" AutoPostBack="true" CssClass="form-control" ToolTip="Question Type" TabIndex="1" OnSelectedIndexChanged="ddlQuestionType_SelectedIndexChanged">
       ...
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtQuestion" runat="server" TextMode="MultiLine" ToolTip="Question" TabIndex="2" CssClass="form-control"></asp:TextBox>
    ...
    <div class="row">
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtAnswer" runat="server" TabIndex="3" CssClass="form-control" ToolTip="Answer" placeholder="Answer"></asp:TextBox></div>
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtMarks" runat="server" TabIndex="4" CssClass="form-control" ToolTip="Marks" placeholder="Marks"></asp:TextBox>
                                                            <nobr> 
