<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="AddCourseDetails.aspx.cs" Inherits="AddCourseDetails" Title="Add Course Details" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     ...
     <div class="row" >
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtCourse" runat="server" CssClass="form-control" TabIndex="3"></asp:TextBox></div>
      </div>
      <div class="row" >
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 form_text field-label">Text Details  :(Max Length-30 Characters)</div>
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtTextDetails" runat="server" CssClass="form-control" TextMode="MultiLine" TabIndex="2" MaxLength="30"></asp:TextBox></div>
      </div>
      </div>
      <div class="user-info media box" style="background-color:#fff;">
