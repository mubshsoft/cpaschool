<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="ScreeningAddSelectSection.aspx.cs" Inherits="Admin_ScreeningAddSelectSection" Title="Section Info" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     <div class="row">
      ...
      <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtNoofSection" placeholder="No. of Section" ToolTip="No. of Section" CssClass="form-control" runat="server"></asp:TextBox></div>
                </div>
