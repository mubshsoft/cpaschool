<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="AddSectionQue.aspx.cs" Inherits="AddSectionQue" Title="Section Detail" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtmax_sec" runat="server"  value='0' onfocus="if(this.value=='0')this.value=''" onblur="if(this.value=='')this.value='0'" ToolTip="Maximum Question" placeholder="Maximum Question" CssClass="form-control"></asp:TextBox>
     ...
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtmaxattempt" runat="server" onblur="if(this.value=='')this.value='0'" onfocus="if(this.value=='0')this.value=''" value="0" ToolTip="Compulsory Question" placeholder="Compulsory Question" CssClass="form-control"></asp:TextBox>
