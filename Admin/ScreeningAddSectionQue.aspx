<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="ScreeningAddSectionQue.aspx.cs" Inherits="ScreeningAddSectionQue" Title="Section Detail" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
      <div class="row">
       ...
       <div class="row">
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtmax_sec" runat="server" CssClass="form-control" ToolTip="Maximum Question" value='0' onfocus="if(this.value=='0')this.value=''" onblur="if(this.value=='')this.value='0'"></asp:TextBox>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtmaxattempt" runat="server" CssClass="form-control" ToolTip="Compulsory Question" 
