<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="AddCaseStudySet.aspx.cs" Inherits="Admin_AddCaseStudySet" %>
...
<section class="fullwidth banner-color">
    <h1 class="heading-color">Add Case Study</h1> 
    <div class="breadcrumbs">
		<ul class="clearfix">
        <li><a href="Adminlogin.aspx">Admin Panel</a></li>
        <li><a href="CaseStudyPanel.aspx">Case Study Panel</a></li>
    ...
    <asp:TextBox ID="txtcasestudycode" ToolTip="Case Study Code" PlaceHolder="Case Study Code" runat="server" CssClass="form-control"></asp:TextBox>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                                        
     <asp:DropDownList ID="ddlCasestudyType" runat="server" ToolTip="Assignment Type" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlAssignmentType_SelectedIndexChanged">
