<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="DeskBroucher.aspx.vb" Inherits="Admin_DeskBroucher" Title="FAQ" %>
 ...
 <form id="form1" runat="server">
    ...
    <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                    
     ...
     <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:Label ID="lblMessage" EnableViewState="false" runat="server" Text="" ForeColor="Red"></asp:Label></div></div>
      <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtTitle" runat="server" ToolTip="Course Title" CssClass="form-control"></asp:TextBox></div>
      </div>
      <div class="row">
