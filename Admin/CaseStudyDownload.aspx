<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="CaseStudyDownload.aspx.cs" Inherits="Admin_CaseStudyDownload" %>
    ...
    <div class="row">
     ...
     <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 center">  &nbsp;</div>
                      ...
                      <asp:LinkButton ID="lnkbtndownloadOrg" runat="server" 
                                                       ...
                                                       <img src="../images/case_study_student.png" /></asp:LinkButton>
                                                        </div>
