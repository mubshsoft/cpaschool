<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InnerMaster.master" CodeFile="AddBanner.aspx.cs" Inherits="Admin_AddBanner" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     ...
     <div class="row" >
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtBannerHeading" runat="server" CssClass="form-control" TabIndex="1"></asp:TextBox></div>
      </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtBannerDesc" runat="server" CssClass="form-control" TextMode="MultiLine" TabIndex="2" MaxLength="50"></asp:TextBox></div>
      </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" >
          <asp:DropDownList ID="ddlDataOrientation" runat="server" CssClass="form-control">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtdataslice1rotation" runat="server" CssClass="form-control" input type="number"  TabIndex="4" ></asp:TextBox>
        ...
        <div class="row" >
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 form_text field-label">Banner Slice 2 Rotation (<small>Add in number</small>)<span style="color: Red">*</span>:</div>
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtdataslice2rotation" runat="server" CssClass="form-control" TabIndex="5"></asp:TextBox>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtdataslice1scale" runat="server" CssClass="form-control" TabIndex="6" ></asp:TextBox>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtdataslice2scale" runat="server" CssClass="form-control" TabIndex="7"></asp:TextBox>
      ...
      <div class="row" >
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 form_text field-label">Banner Image Upload :</div>
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:FileUpload ID="FileUpload1" runat="server" />
          <small>Image Dimensions (Width 1368 px * Height 328 px) </small>
      </div>
         
      </div>
      <div class="row">&nbsp;</div>
     <div class="row" >
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 form_text field-label" >Course Offered Icon Upload :</div>
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:FileUpload ID="FileUpload2" runat="server" />
          <small>Image Dimensions (Width 50 px * Height 34 px) </small>
      </div>
         
      </div>
<div class="row">&nbsp;</div>
      <div class="row" ><div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">&nbsp;</div><div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" >
      ...
      <div class="row" ><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" ><asp:HiddenField ID="hdncourseId" runat="server" />
           ...
           <asp:HiddenField ID="hdnCourseOfferedIcon" runat="server" />
                                                   </div></div>
                                                   </div>
                                                   </section>
                                       <%-- </ContentTemplate>
