...
Imports fmsf.DAL
Imports fmsf.lib
Partial Class Admin_videoConfrence
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            ElseIf ddlCourse.SelectedIndex <> 0 And ddlBatch.SelectedIndex <> 0 And ddlSemester.SelectedItem.Text = "--Select--" Then
                strEmail = "select bt.bid,bt.stid,st.firstname,st.lastname,st.email,bt.courseid from StudentRegBatch bt INNER JOIN Student st on bt.stid=st.stid INNER JOIN batch b on bt.bid=b.bid where bt.bid=" & ddlBatch.SelectedValue
            ElseIf ddlCourse.SelectedIndex <> 0 And ddlBatch.SelectedIndex <> 0 And ddlSemester.SelectedIndex <> 0 Then
        ...
        strReminder = "insert into VideoConfrence(Subject,Body,SendFrom,stid,confrencelink,CourseId,bid,SemesterId,ConfreenceDate)values('" & txtSubject.Text & "','" & txtreply.Text & "','" & strFrom & "','" & studentid & "','" & txtLink.Text & "'," & ddlCourse.SelectedValue.Trim() & "," & ddlBatch.SelectedValue.Trim() & "," & ddlSemester.SelectedValue.Trim() & ",'" & txtdt.Text & "')"
        ...
        Try
            ...
            CommonUtility.SendMail(ConfigurationSettings.AppSettings("Admin").Split(New Char() {";"c})(0), ConfigurationSettings.AppSettings("Admin").Split(New Char() {";"c})(1), ViewState("StMail"), "", "", "", txtSubject.Text, txtreply.Text)
            ...
            'lblMessage.Text = "Video Confrence addedd successfully"
            Response.Redirect("ListvideoConfrence.aspx", False)
    ...
    Protected Sub btnClose_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnClose.Click
        Response.Redirect("ConferencePanel.aspx")
    End Sub
End Class
