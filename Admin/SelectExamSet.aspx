<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="SelectExamSet.aspx.cs" Inherits="SelectExamSet" Title="Course Evaluation Criteria" %>
...
input[type=checkbox], input[type=radio] {
  ...
  <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="pull-right"><asp:button ID="btnback" runat="server" Text="Back" CssClass="btn btn-large btn-warning" onclick="btnback_Click" /></span></div>
    </div>
    <div class="row" >&nbsp;</div>
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlCourse" AutoPostBack="true"  runat="server" ToolTip="Course Code" CssClass="form-control" onselectedindexchanged="ddlCourse_SelectedIndexChanged" />
    <asp:Label ID="lblreqcourse" runat="server" Text="" ForeColor="Red"></asp:Label></div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlbatch" AutoPostBack="true"  runat="server" ToolTip="Batch Id" CssClass="form-control"  />
    <asp:Label ID="lblBatch" runat="server" Text="" ForeColor="Red"></asp:Label></div>
    </div>
     <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlSem" AutoPostBack="true"  runat="server" ToolTip="Semester" CssClass="form-control" onselectedindexchanged="ddlSem_SelectedIndexChanged" />
                                                          <asp:Label ID="lblreqsem" runat="server" Text="" ForeColor="Red"></asp:Label></div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlModule" AutoPostBack="true"  runat="server" ToolTip="Module" CssClass="form-control" onselectedindexchanged="ddlModule_SelectedIndexChanged" />
                                                          <asp:Label ID="lblreqmodule" runat="server" Text="" ForeColor="Red"></asp:Label></div>
    </div>  
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlPaper"  runat="server" ToolTip="Paper" CssClass="form-control" />
