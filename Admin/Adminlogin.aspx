<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="Adminlogin.aspx.vb" Inherits="AdminLogin" Title="Admin Panel" %>
...
input[type=checkbox], input[type=radio] {
   ...
   <div class="breadcrumbs">
    ...
    <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 center"><a href="ConferencePanel.aspx"><img src="../Images/VideoConf.png" style="border:0px" /></a></div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 center"><a href="CaseStudyPanel.aspx"><img src="../Images/case_study.png" style="border:0px" /></a></div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 center"><a href="ListSocial.aspx"><img src="../Images/socialmedia.png" style="border:0px" /></a></div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 center"><a href="AssignModule.aspx"><img src="../Images/assign-module-batch.png" style="border:0px" /></a></div>
                </div> 
                </div>
