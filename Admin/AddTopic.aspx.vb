        ...
        Try
            ...
            If objLibErr.ChkReturn = True Then
                ...
                ElseIf retVal = 1 Then
                    Dim Notifications As String = "insert into Notifications(Subject,Body,SendFrom,CourseId)values('Discussion Forum is uploaded','Discussion Forum','Admin'," & ddlCourse.SelectedValue & ")"
