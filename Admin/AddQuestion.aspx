<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="AddQuestion.aspx.cs" Inherits="Admin_AddQuestion" Title="Add Question" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><legend><asp:Label ID="lblSection" runat="server" Text="" ForeColor="#4b4b4b"></asp:Label></legend></div>
    </div>
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
<asp:DropDownList ID="ddlQuestionType" runat="server" AutoPostBack="true" ToolTip="Question Type" CssClass="form-control"
    ...
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:TextBox ID="txtQuestion" runat="server" TextMode="MultiLine" Rows="4" TabIndex="3" ToolTip="Question" PlaceHolder="Question" CssClass="form-control"></asp:TextBox>
