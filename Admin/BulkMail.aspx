<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="BulkMail.aspx.vb" Inherits="Admin_BulkMail" Title="Sending Mail" %>
    ...
    <%--<div onkeypress="HideMessage()"></div>--%>
     ...
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                    
      ...
      <div class="user-info media box" style="background-color:#fff;">
                 ...
                 <asp:DropDownList ID="ddlBatch" runat="server" AutoPostBack="true" CssClass="form-control" ToolTip="Select Batch"   ></asp:DropDownList>
                  </div>
                  </div>
                  <div class="row">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="left">
                  <asp:TextBox ID="txtSubject" runat="server" CssClass="form-control" ToolTip="Subject" Placeholder="Subject"  ></asp:TextBox>
                   ...
                   <div class="row">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="left">                        
                      <asp:TextBox ID="txtMessage"  runat="server" CssClass="form-control" ToolTip="Message" Placeholder="Message.." TextMode="MultiLine" Rows="6" ></asp:TextBox>
                         </div>
                         </div>
                         <div class="row"> &nbsp;</div>
                         <div class="row"> 
