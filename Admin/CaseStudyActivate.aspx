<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="CaseStudyActivate.aspx.cs" Inherits="Admin_CaseStudyActivate" %>
...
<section class="fullwidth banner-color">
    <h1 class="heading-color"><asp:Label ID="lblCaption" runat="server" text="Assign Case Study" /></h1> 
    <div class="breadcrumbs">
		<ul class="clearfix">
        <li><a href="Adminlogin.aspx">Admin Panel</a></li>
        <li><a href="CaseStudyPanel.aspx">Case Study</a></li>
        <li class="active">Assign Case Study</li>
		</ul>
	</div>
    </section>
    ...
    <asp:DropDownList ID="ddlCaseStudyset" runat="server" ToolTip="Case Study Set" placeholder="Case Study Set" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlCaseStudyset_SelectedIndexChanged">
                                                                    </asp:DropDownList>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
 <asp:DropDownList ID="ddlbatch" runat="server" ToolTip="Batch Code" CssClass="form-control"></asp:DropDownList>
    </div>
    </div>                                                         
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:TextBox ID="txtactivateDate" runat="server" ToolTip="Activation Date" placeholder="Activation Date" CssClass="form-control"></asp:TextBox>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:TextBox ID="txtDeactivateDate" runat="server" ToolTip="Deactivation Date" placeholder="Deactivation Date" CssClass="form-control"></asp:TextBox><a href="javascript:NewCal('<%= txtDeactivateDate.ClientID %>','mmddyyyy')"> <img src="../images/calender.png" width="22" height="22" border="0" alt="Pick a date" class="icon-position"></a>&nbsp;<asp:Label ID="lblDeactivateDate" runat="server" Text="" ForeColor="Red"></asp:Label>
    </div> 
    </div>                                                        <%-- <tr>
                                                        <td colspan="2">
