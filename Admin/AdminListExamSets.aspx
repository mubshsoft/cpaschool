<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="AdminListExamSets.aspx.vb" Inherits="Admin_AdminListExamSets" %>
...
input[type=checkbox], input[type=radio] {
  ...
  <section class="container main m-tb">
    <div class="user-info media box" style="background-color:#fff;">
        ...
        <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlListExamSet" runat="server" AutoPostBack="true" CssClass="form-control" ToolTip="Exam Set code">
                                                                    </asp:DropDownList>
                                                                    </div></div>
