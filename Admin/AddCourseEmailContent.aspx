<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="AddCourseEmailContent.aspx.cs" Inherits="AddCourseEmailContent" Title="Add Course Email Content" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtcourseemailid"  ToolTip="Course EMail-Id" PlaceHolder="Course EMail-Id" CssClass="form-control" runat="server"  /></div></div>
