<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddNewSemester.aspx.vb" Inherits="Admin_AddNewSemester" %>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td width="50%" align="left" style="padding-left: 10px">
                                                            <strong class="style9_sec">Add Semester</strong>
                                                        </td>
                                                ...
                                                <table width="300px">
                                                    ...
                                                    <tr>
                                                        <td width="150px" colspan="2" style="width: 300px;" align="center">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtNoOfSemester"
                                                                ErrorMessage="Please enter numeric values" ValidationExpression="(^[0-9]*\d*\d{1}?\d*)$"></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="260px" align="right" style="padding-right:10px">
                                                            No Of Semester :</td>
                                                        <td width="40px" align="left">
                                                            <asp:TextBox ID="txtNoOfSemester" runat="server" CssClass="style11"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                   <%-- <tr>
                                                        <td colspan="2">
