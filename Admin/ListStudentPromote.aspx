<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="ListStudentPromote.aspx.vb" Inherits="Admin_ListStudentPromote" Title="List of Batch" %>
...
<div class="user-info media box" style="background-color:#fff;">
    ...
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="true" CssClass="form-control" ToolTip="Course"></asp:DropDownList></div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="trbatch" runat="server"><asp:DropDownList ID="ddlbatch" runat="server" AutoPostBack="true" CssClass="form-control" ToolTip="Batch"></asp:DropDownList></div>
    </div>
</div>
    <div class="row" >
...
<asp:GridView ID="GrdBatch" AutoGenerateColumns="False" DataKeyNames="bid" Width="100%" CssClass="table" PagerSettings-LastPageText="Last" PagerSettings-Mode="NumericFirstLast" PagerStyle-HorizontalAlign="Center" PageSize="10" runat="server" AllowPaging="True" OnPageIndexChanging="GrdBatch_PageIndexChanging">
