     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
          <ContentTemplate>
           ...
           <fieldset><legend>Add Date</legend>
            <div class="row-fluid" >
            <div class="span6">
            <asp:TextBox ID="txtSentDate" runat="server" CssClass="form-control" ToolTip="Date Sent" placeholder="Date Sent"></asp:TextBox>
            ...
            <div class="span6">
            <asp:TextBox ID="txtReceivedDate" runat="server" CssClass="form-control" ToolTip="Date Received" placeholder="Date Received"></asp:TextBox>
