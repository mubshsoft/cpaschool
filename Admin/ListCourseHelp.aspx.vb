...
Partial Class Admin_ListCourseHelp
    ...
    Sub BindGrid()
        ...
        Try
            ...
            Dim strq As String = "select cs.*,isnull(br.HelpDeskFilepath,'') as HelpDeskFilepath,isnull(br.BroucherFilepath,'') as BroucherFilepath,isnull(br.CalendarFilepath,'') as CalendarFilepath from coursedetails cs LEFT OUTER JOIN HelpDeskBroucher br on br.courseid=cs.courseid"
