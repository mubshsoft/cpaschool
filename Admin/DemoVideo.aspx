<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="DemoVideo.aspx.cs" Inherits="Admin_DemoVideo" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:Label ID="lblMessage" EnableViewState="false" runat="server" Text="" ForeColor="Red"></asp:Label></div></div>
      ...
      <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" ><asp:TextBox ID="txtCaption" runat="server" CssClass="form-control" TabIndex="3"></asp:TextBox></div>
      </div>
