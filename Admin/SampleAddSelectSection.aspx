<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="SampleAddSelectSection.aspx.cs" Inherits="Admin_SampleAddSelectSection" Title="Section Info" %>
...
<asp:TextBox ID="txtNoofSection" runat="server" ToolTip="No. of Section" placeholder="No. of Section" CssClass="form-control"></asp:TextBox>
                </div></div>
