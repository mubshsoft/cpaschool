<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="ManagebatchByAdmin.aspx.vb" Inherits="Admin_ManagebatchByAdmin" Title="Manage Batch" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <section class="container main m-tb">
                ...
                <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                          <ContentTemplate >
                                                            <asp:DropDownList ID="ddlBatch" runat="server" AutoPostBack="true" ToolTip="Batch Code" CssClass="form-control">
                                                            </asp:DropDownList>
                                                             </ContentTemplate>
                                    </asp:UpdatePanel>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                     <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                          <ContentTemplate >
                                                <asp:GridView ID="GrdStudent" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table" PagerSettings-LastPageText="Last" PagerSettings-Mode="NumericFirstLast" PagerStyle-HorizontalAlign="Center" PageSize="10"
                                                    runat="server" AllowPaging="True" OnPageIndexChanging="GrdStudent_PageIndexChanging" OnRowCommand="GrdStudent_RowCommand" OnRowDeleting="GrdStudent_RowDeleting">
...
<PagerSettings LastPageText="Last" Mode="NumericFirstLast" />
                                                    ...
                                                    <Columns>
                                                       <asp:TemplateField HeaderText="student Batch Id" Visible="false" ItemStyle-HorizontalAlign="Left">
                                                        ...
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Left">
                                                            <HeaderTemplate>
                                                                <asp:CheckBox ID="chkHeader" runat="server" onclick="javascript:SelectAllCheckboxes(this);"  />Select All</HeaderTemplate>
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chk" Checked='<%# Eval("Approve") %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField>
                                                            <ItemTemplate>
                                                               <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Id") %>' OnClientClick ="return confirm('Are you sure you want to delete?')">Delete</asp:LinkButton>
                                                               <%-- <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Id") %>'>Delete</asp:LinkButton>--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <a href="EditStudentBatch.aspx?stid=<%# Eval("stid") %>&cid=<%#Container.DataItem("courseid") %>&bid=<%#Container.DataItem("bid") %>&email=<%#Container.DataItem("email") %>">Re-assign in Another Batch</a>
                  ...
                  <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center"><asp:Button ID="btnSave" Text="Save" CssClass="btn btn-success btn-large " runat="server" />
