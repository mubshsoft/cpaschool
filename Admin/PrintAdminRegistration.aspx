<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrintAdminRegistration.aspx.vb" Inherits="Admin_PrintAdminRegistration" %>
    ...
    <div align="center">
        <table width="680px">
                ...
                <td align="left" colspan="4">
                    <table class="style14" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtStream1" runat="server"  CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtStream2" runat="server"  CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                        ...
                        <tr>
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtStream3" runat="server"  CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                        ...
                        <tr>
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtBoard4" runat="server" CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>&nbsp;
                            </td>
                            <td class="framecell">
            ...
            <tr>
                ...
                <td style="padding-right: 10px;" align="right" class="NormalText">
                    Place :
                </td>
                <td align="left" colspan="2">
