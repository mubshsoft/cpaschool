<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="AddEvent.aspx.vb" Inherits="Admin_AddEvent" Title="List of Event" %>
...
<section class="fullwidth banner-color">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
     <div class="user-info media box" style="background-color:#fff;">  
        ...
        <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtDate" runat="server" PlaceHolder="Event Date" ToolTip="Event Date" CssClass="form-control" ></asp:TextBox></div>
