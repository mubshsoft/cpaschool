<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="SampleAddQuestion.aspx.cs" Inherits="Admin_SampleAddQuestion" Title="Add Question" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <section class="container main m-tb">
                                ...
                                --%>
                                 ...
                                 <asp:DropDownList ID="ddlQuestionType" runat="server" AutoPostBack="true" CssClass="form-control" ToolTip="Question Type"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtAnswer" runat="server" TabIndex="2" CssClass="form-control" ToolTip="Answer" placeholder="Answer"></asp:TextBox>
                                </div>
                                </div>
                                <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtQuestion" runat="server" TextMode="MultiLine" TabIndex="3" Rows="4" CssClass="form-control" ToolTip="Question"></asp:TextBox>
                                 ...
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtMarks" runat="server" TabIndex="4" CssClass="form-control"></asp:TextBox>
                                                            <nobr> 
