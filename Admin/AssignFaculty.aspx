<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="AssignFaculty.aspx.vb" Inherits="Admin_AssignFaculty" Title="Assign Faculty" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     ...
     <div class="row">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox id="txtName" runat="server" ToolTip="Faculty Name" CssClass="form-control"></asp:TextBox></div>
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="dllCourse" runat="server" ToolTip="Course" CssClass="form-control" AutoPostBack="true" ></asp:DropDownList></div>
     </div>
     <div class="row">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="dllSemester" runat="server" ToolTip="Semester" CssClass="form-control" AutoPostBack="true" ></asp:DropDownList></div>
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="dllModule" runat="server" ToolTip="Module" CssClass="form-control" AutoPostBack="true"></asp:DropDownList></div>
     </div>
     <div class="row">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="dllPaper" runat="server" ToolTip="Paper" CssClass="form-control" AutoPostBack="true"></asp:DropDownList></div>
