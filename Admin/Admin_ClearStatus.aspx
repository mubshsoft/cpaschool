<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="Admin_ClearStatus.aspx.vb" Inherits="Admin_ClearStatus" Title="List of Student" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <section class="container main m-tb">
        ...
        <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">(select semester only if you want to change previous semester marks and fee status)</div>
                </div>
     <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="pull-right"><asp:Button ID="imgBack" Text="Back" CssClass="btn btn-large btn-primary" runat="server"/></span></div>
                </div>
      <div class="row">
    ...
    <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlSem" runat="server" ToolTip="Select Semester" AutoPostBack="true" CssClass="form-control"></asp:DropDownList></div>
                </div>
    <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><b><%=semTitle%></b>&nbsp; || &nbsp;<%=stEmail%></div>
            </div>
    <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form_head">Marks</div>
                </div>
</div>
    
    <div class="user-info media box" style="background-color:#fff;">
<div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 center"><asp:ImageButton ID="imgDetail" runat="server" ImageUrl="../Images/marks_detail.png" /></div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 center"><asp:ImageButton ID="imgMarksComplete" runat="server" ImageUrl="../Images/completed.png" OnClientClick="return confirm('Are you sure to set marks completed of current semester? Click OK to Completed Marks of current semester.');" ToolTip="Click here to Marks Completed of current semester"/></div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 center"><asp:ImageButton ID="imgMarksnotComplete" runat="server" ImageUrl="../Images/incompleted.png" OnClientClick="return confirm('Are you sure to set marks incompleted of current semester? Click OK to Incompleted Marks of current semester.');" ToolTip="Click here to Marks Incompleted of current semester"/></div>
                </div>
                </div>
                <div class="row">&nbsp;</div>
<div class="user-info media box" style="background-color:#fff;">
     <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form_head" style="padding-left: 1em; margin-top: -10px;">Fees</div>
                </div>            
     
     
<div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 center"><asp:ImageButton ID="imgFeesDetail" runat="server" ImageUrl="../Images/fees_detail.png" />
                                                            <%--  <asp:ImageButton ID="imgFeesDetail" runat="server"  ImageUrl="../Images/fees_detail.png"/>--%>
                                                        </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 center"><asp:ImageButton ID="ImgFeesPaid" runat="server" ImageUrl="../Images/fees_paid.png" OnClientClick="return confirm('Are you sure to set Fees Paid of current semester? Click OK to Fees Paid of current semester.');" ToolTip="Click here to Fees Paid of current semester"/></div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 center"><asp:ImageButton ID="ImgFeesUnpaid" runat="server" ImageUrl="../Images/unpaid.png" OnClientClick="return confirm('Are you sure to set Fees Unpaid of current semester? Click OK to Fees Unpaid of current semester.');" ToolTip="Click here to Fees Unpaid of current semester"/></div>
               </div>  
               </div>                                       
      <div class="row">
