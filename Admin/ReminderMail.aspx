<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="ReminderMail.aspx.vb" Inherits="Admin_ReminderMail" ValidateRequest="false" Title="Sending Mail" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <section class="container main m-tb">
                                   ...
                                   <%--<asp:LinkButton ID="AddNew" runat="server" 
                                          ...
                                          <div class="row">
                                          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlSemester" runat="server" placeholder="Semester" ToolTip="Semester" CssClass="form-control" AutoPostBack="true"></asp:DropDownList></div>
                                          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlStd" runat="server" placeholder="Student" ToolTip="Student" CssClass="form-control"></asp:DropDownList></div>
                                          </div>
                                          <div class="row">
                                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtSubject" placeholder="Subject" ToolTip="Subject" runat="server" CssClass="form-control"></asp:TextBox></div>
                                          </div>
