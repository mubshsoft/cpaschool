<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="SelectStudentPerformance.aspx.vb" Inherits="Admin_SelectStudentPerformance" Title="List Student" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:Label ID="lblMessage" EnableViewState="false" runat="server" Text="" ForeColor="Red"></asp:Label></div>
     ...
     <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlCourse" runat="server" ToolTip="Course" AutoPostBack="true" CssClass="form-control"></asp:DropDownList></div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlBatch" runat="server" ToolTip="Batch" AutoPostBack="true" CssClass="form-control"></asp:DropDownList></div>
    </div>                                                   </td>
    <div class="row" >
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow:auto">
                       <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                ...
                                                <asp:GridView ID="GrdStudent" AutoGenerateColumns="False" OnRowDataBound="grdExamSet_RowDataBound" DataKeyNames="stid" Width="100%"
                                                    runat="server" AllowPaging="True" OnRowCommand="GrdStudent_RowCommand" CssClass="table" PagerSettings-LastPageText="Last" PagerSettings-Mode="NumericFirstLast" PagerStyle-HorizontalAlign="Center" PageSize="10" >
