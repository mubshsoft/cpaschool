<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="ListBatch.aspx.vb" Inherits="Admin_ListBatch" Title="List of Batch" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <section class="container main m-tb">
                ...
                <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="true" ToolTip="Select Course" CssClass="form-control"></asp:DropDownList></div>
                </div>
                    

                <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="pull-right"><asp:Button ID="ImgMgBatch" runat="server" PostBackUrl="~/Admin/ManageBatch.aspx" Text="Assign Student in Batch" CssClass="btn btn-warning" /></span>
