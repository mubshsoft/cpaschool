<%@ Page MasterPageFile="~/InnerMaster.master" Language="C#" AutoEventWireup="true" CodeFile="AssignmentAddQuestion.aspx.cs" Inherits="Admin_AssignmentAddQuestion" Title="Add Question" %>
...
<section class="fullwidth banner-color">
    <h1 class="heading-color">Add Question</h1> 
  ...
  <div>
    ...
    <asp:DropDownList ID="ddlQuestionType" runat="server" AutoPostBack="true" CssClass="form-control" TabIndex="1" onselectedindexchanged="ddlQuestionType_SelectedIndexChanged">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:TextBox ID="txtMarks" runat="server" TabIndex="2" ToolTip="Marks" placeholder="Marks" CssClass="form-control"></asp:TextBox>
                                                            <nobr> 
                                                            <asp:RegularExpressionValidator ID="regRefFee0" runat="server" 
    ...
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtQuestion" runat="server" TextMode="MultiLine" TabIndex="3" Rows="4" ToolTip="Question" placeholder="Question" CssClass="form-control"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rqdSurveyQuestion" runat="server" Display="Dynamic" ControlToValidate="txtQuestion" ErrorMessage="Enter  Question " ValidationGroup="1"></asp:RequiredFieldValidator>
                                                                 <FCKeditorV2:FCKeditor ID="Editor1" runat="server" BasePath="~/fckeditor/" Height="200px" Width="580px" Visible="false"></FCKeditorV2:FCKeditor>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:TextBox ID="txtAnswer" runat="server" TextMode="MultiLine" Rows="4" TabIndex="4" ToolTip="Answer" placeholder="Answer" CssClass="form-control" ></asp:TextBox>
    </div>
    </div>
  ...
  <div class="row" >
   ...
   <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow:auto">                                            
                                                ...
                                                <asp:GridView ID="gvQuestionList" runat="server" AllowPaging="true" CssClass="table"
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="linkDeleteQuestion" runat="server" CausesValidation="false" 
                                                                    CommandName="Delete" Font-Underline="false" CommandArgument='<%# Eval("QuestionId") %>'> 
