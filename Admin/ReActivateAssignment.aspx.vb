...
Partial Class Admin_ReActivateAssignment
    ...
    Private Sub FillDDlAssignmentset()
        ...
        Try
            Dim strq As String = "select * from Assignmentset ex inner join activateAssignment ax on ex.Asgnid = ax.Asgnid where active = 1 And ax.bid = " & ddlBatch.SelectedValue '& " And ex.courseid=" & ddlcourse.SelectedValue
                ...
                If dsasgn.Tables IsNot Nothing Then
                    If dsasgn.Tables(0).Rows IsNot Nothing Then
                        If dsasgn.Tables(0).Rows.Count > 0 Then
                            ddlAssignmentset.DataTextField = "AsgnCode"
    ...
    Sub bindgrid()
        Try
            Dim strq As String = "select ae.id,ae.AsgnId,ae.bid,ae.UserId,ae.Activate,ae.ActivateDate,bt.BatchCode from StudentActiveAssignment ae INNER JOIN batch bt on ae.bid=bt.bid where ae.AsgnId=" & ddlAssignmentset.SelectedValue & " and ae.bid=" & ddlBatch.SelectedValue & " and ae.Activate=1"
    ...
    Protected Sub GrdStudent_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GrdStudent.RowUpdating
        ...
        Dim str As String = "update StudentActiveAssignment set Activate=0 where id=" & Convert.ToInt32(lbl.Text)
        ExeNQcomsp(str)
        bindgrid()
    End Sub
    ...
    Protected Sub btnback_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnback.Click
        Response.Redirect("AssignmentPanel.aspx")
    End Sub
