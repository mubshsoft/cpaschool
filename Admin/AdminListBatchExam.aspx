<%@ Page MasterPageFile="~/InnerMaster.master" Language="VB" AutoEventWireup="false" CodeFile="AdminListBatchExam.aspx.vb" Inherits="Admin_AdminListBatchExam" Title="List of Batch for Exam" %>
  ...
  <section class="container main m-tb">
    <div class="user-info media box" style="background-color:#fff;">
        ...
        <div class="row"><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="true" ToolTip="Course" CssClass="form-control">
                               ...
                               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="trbatch" runat="server"><asp:DropDownList ID="ddlbatch" runat="server" AutoPostBack="true" ToolTip="Batch" CssClass="form-control">
                                                            </asp:DropDownList></div>
        </div>
        ...
        <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center"><asp:button ID="btnback" Text="Back" CssClass="btn btn-large btn-warning" runat="server" /></div></div>
         ...
         <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow:auto">
                                                ...
                                                <asp:GridView ID="GrdBatch" AutoGenerateColumns="False" DataKeyNames="bid" Width="100%" CssClass="table" PagerSettings-LastPageText="Last" PagerSettings-Mode="NumericFirstLast" PagerStyle-HorizontalAlign="Center" PageSize="10"
