        ...
        try
        {
            ...
            if (objLibListing != null)
            {
                ...
                { 
                    ...
                    CommonUtility.SendMail(ConfigurationSettings.AppSettings["coordinator"].Split(new char[] { ';' })[0], ConfigurationSettings.AppSettings["coordinator"].Split(new char[] { ';' })[1], txtEmail.Text, "", "", "", "Password from fmsflearningsystems ", strBody);
    ...
    private void sendEmailtoUser(string uemail, string userName, string userPassword)
    {
        try{
            ...
            SmtpClient SmtpServer = new SmtpClient("relay-hosting.secureserver.net");
                ...
                mail.From = new MailAddress("coordinator@fmsflearningsystems.org", "fmsf@123");
                mail.To.Add(uemail);
