<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="Registration1.aspx.vb" Inherits="Registration1" Title="Registration" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
                ...
                <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtDOB" runat="server" CssClass="input-block-level" required="required"></asp:TextBox>
                ...
                <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtPermanentAddress" runat="server" CssClass="input-block-level"
                 ...
                 <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtCorrespondenceAddress" runat="server" CssClass="input-block-level"
                ...
                <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtContactNumber" runat="server" CssClass="input-block-level"></asp:TextBox>
                ...
                <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtMobileNumber" runat="server" CssClass="input-block-level"></asp:TextBox>
