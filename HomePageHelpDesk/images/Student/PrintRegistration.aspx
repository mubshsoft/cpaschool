<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrintRegistration.aspx.vb"
    Inherits="PrintRegistration" %>
    ...
    <div align="center">
        <table width="680px">
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    <asp:Label ID="lblCourseID" runat="server" CssClass="style11feedback_sec" />
                </td>
            </tr>
            <tr style="background-color: #E4E4E4">
                <td align="left" colspan="4" style="color: Black; padding-left: 13px;" class="NormalText">
            ...
            <tr>
                ...
                <td align="center" rowspan="4"  valign="middle" style="background-color: #cccccc; border-right:1px solid #4b4b4b; border-top:1px solid #4b4b4b; border-left:1px solid #4b4b4b;border-bottom:1px solid #4b4b4b; font-family:Tahoma; font-size:9px;" >
                    <b>Paste Your Photo</b>
                </td>
            </tr>
            <tr>
                <td align="left">
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    <asp:TextBox ID="txtApplicantCategory" runat="server" Height="18px" CssClass="style11feedback_sec "></asp:TextBox>    
                       </td>
            </tr>
            <tr>
                <td align="left">
                ...
                <td align="left" colspan="4">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr style="height: 16px;">
                            ...
                            <td width="28%"  class="NormalText" align="center">
                               Name of the Univ./Board
                            </td>
                            <td width="27%"   class="NormalText" align="center">
                                Stream
                            </td>
                        ...
                        <tr>
                            <td  class="NormalText" style="padding-left: 5px; vertical-align:middle">
                               10<sup>th</sup>
                            </td>
                            <td class="framecell">
                                <asp:TextBox ID="txtBoard1" runat="server"  
                                    CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>&nbsp;
                            </td>
                            <td class="framecell">
                                <asp:TextBox ID="txtStream1" runat="server"
                                     CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                                <asp:TextBox ID="txtMarks1" runat="server" Height="18px" CssClass="style11feedback_small"
                                    MaxLength="15"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                        ...
                        <tr>
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtBoard2" runat="server" 
                                     CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>&nbsp;
                            </td>
                            <td class="framecell">
                                <asp:TextBox ID="txtStream2" runat="server" 
                                     CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                                <asp:TextBox ID="txtMarks2" runat="server" Height="18px" CssClass="style11feedback_small"
                                    MaxLength="15"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                        ...
                        <tr>
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtBoard3" runat="server" 
                                     CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>&nbsp;
                            </td>
                            <td class="framecell">
                                <asp:TextBox ID="txtStream3" runat="server" 
                                     CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                                <asp:TextBox ID="txtMarks3" runat="server" Height="18px" CssClass="style11feedback_small"
                                    MaxLength="15"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                        ...
                        <tr>
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtBoard4" runat="server" 
                                     CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>&nbsp;
                            </td>
                            <td class="framecell">
                                <asp:TextBox ID="txtStream4" runat="server"   CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                                <asp:TextBox ID="txtMarks4" runat="server" Height="18px" CssClass="style11feedback_small"
                                    MaxLength="15"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
            ...
            <tr>
                <td align="left" colspan="4">
                    <table class="style14" cellpadding="0" cellspacing="0">
                        <tr style="height: 16px;">
                            <td width="35%" class="NormalText" align="center">
                        ...
                        <tr>
                            <td class="framecell">
                                <asp:TextBox ID="txtOrg1" runat="server"   CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>&nbsp;
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtDesignation1" runat="server"  CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                        ...
                        <tr>
                            <td class="framecell">
                                <asp:TextBox ID="txtOrg2" runat="server"  CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>&nbsp;
                            </td>
                            <td class="framecell" style="vertical-align:middle"> 
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtDesignation2" runat="server"  CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                        ...
                        <tr>
                            <td class="framecell">
                                <asp:TextBox ID="txtOrg3" runat="server"  CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>&nbsp;
                            </td>
                            <td class="framecell" style="vertical-align:middle">
                            ...
                            <td class="framecell">
                                <asp:TextBox ID="txtDesignation3" runat="server"  CssClass="style11feedback_MultiLine" Rows="3" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td class="framecell" style="vertical-align:middle">
           ...
           <table width="100%" cellpadding="0" cellspacing="0"><tr>
                ...
                <td  width="10%" style="padding-left: 20px;" align="left" class="NormalText">
                    Place:
                </td>
                <td align="left">
