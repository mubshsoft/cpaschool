...
public partial class Student_CourseMaterial_old : System.Web.UI.Page
{
    int cid = 0;
    ...
    private void GetSourceMaterial(int SemesterId)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                string heading = ds.Tables[0].Rows[i]["Mode"].ToString();
                ...
                {
                    sb.Append("<a href = '../DownloadDetail.aspx?dt=lc&paperid=" + paperid + "&unitid=" + unitid + "' id='" + id + "' >" + strq + "</a>");
                }
                sb.Append("</h4>");
                sb.Append("</div>");
                ...
                if (heading == "View")
                {
                    if(strFilepath.ToLower().EndsWith(".mp4") || strFilepath.ToLower().EndsWith(".mp3"))
                    {
                        string AddNote = "1";
                        sb.Append("<a href = '#' id='" + id + "' onclick ='javascript:ViewResourceFile(" + courseid + "," + paperid + "," + unitid + "," + AddNote + ")' >Add Note While Watching Video- " + unittitle + "</a>");
                    ...
                    else
                    {
                        ...
                        {
                            sb.Append("<a href = '#' id='" + id + "' onclick ='javascript:ViewResourceFile(" + courseid + "," + paperid + "," + unitid + "," + AddNote + ")' >View File - " + unittitle + "</a>");
                            sb.Append(" | <a href = 'ViewAssessmentsChapter.aspx?ID=" + unitid + "' id='" + id + "'  > View Assessments Chapter</a>");
                        }
                        else
                        {
                            sb.Append("<a href = '#' id='" + id + "' onclick ='javascript:ViewResourceFile(" + courseid + "," + paperid + "," + unitid + "," + AddNote + ")' >View File - " + unittitle + "</a>");
                ...
                {
                    sb.Append("<a href = '../DownloadDetail.aspx?dt=lc&paperid=" + paperid + "&unitid=" + unitid + "' id='" + id + "' >Download</a>");
                    //sb.Append("<p>" + strans + "</p>");
                }
                
                //sb.Append("<a href = '#'  onclick ='javascript:ViewResourceFile(53,209)' >" + strans + "</a>");
