<%@ Page Language="C#" MasterPageFile="~/Student/StudentMaster.master" AutoEventWireup="true" CodeFile="SubmitOnlineScreening.aspx.cs" Inherits="SubmitOnlineScreening" %>
        ...
        if (seconds == 0) {
            ...
            if (minutes == 0) {
                ...
                if (hours == 0) {
                    ...
                    window.location = 'EndScreening.aspx';
                    //return;
                }
                else {
...
<div class="content-wrapper" onload="mySubmit();" oncontextmenu="return false;" onkeypress="disableCtrlKeyCombination(event);" onkeydown="disableCtrlKeyCombination(event);"
    ...
    <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Submit Screening</li>
          </ol>
        </section>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:Panel ID="panel" runat="server">
                                                                                    ...
                                                                                    <asp:HiddenField ID="hdnQuestionId" runat="server" Value='<%# Eval("QuestionId") %>' />
                                                                                       <asp:HiddenField ID="hdnSecQueno" runat="server" Value='<%# Eval("ROWID") %>' />                                                                            </asp:Panel>
                                                                                            ...
                                                                                            <td align="center" valign="middle" width="30%" style="padding-top:7px;">
                                                                                                <table width="100%" height="50" border="0" cellpadding="0" cellspacing="0">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="center" valign="middle">
                                                                                                            <asp:ImageButton ID="btnEndScreening" runat="server" ImageUrl="~/Images/end_Screening.png"
                                                                                                                border="0" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','../Images/end_exam_button_roll.jpg',1)"
                                                                                                                OnClick="btnEndScreening_Click" 
                                                                                                                OnClientClick="return confirm('You are about to end the exam click OK to end the exam.');" 
                                                                                                                Visible="False" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
