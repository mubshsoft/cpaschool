<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubmitManualAssignment.aspx.cs" Inherits="Student_SubmitManualAssignment" %>
                                            ...
                                            <td height="100%" class="style5" align="center" style="padding-top: 2px; padding-bottom: 2px;">
                                                <table width="400px">
                                                   ...
                                                   <%-- <tr>
                                                    ...
                                                    <tr>
                                                        <td width="150px" colspan="2" style="width: 400px">
                                                            <asp:button ID="btnSave" text="Save" runat="server" CssClass="btn btn-success" onclick="btnSave_Click"/>&nbsp;&nbsp;&nbsp;
                                                           <asp:button ID="btnClose" text="Close" runat="server" onclick="btnClose_Click" CssClass="btn btn-warning" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
