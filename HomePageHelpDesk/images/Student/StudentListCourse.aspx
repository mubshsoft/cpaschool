<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Student/StudentMaster.master" CodeFile="StudentListCourse.aspx.vb" Inherits="Student_StudentListCourse" Title="List of Course" %>
<%--
    ...
    <%--<div onkeypress="javascript:HideMessage()"></div>--%>
                                ...
                                <%--   <asp:SiteMapDataSource ID="_mainMenuDataSource" runat="server" ShowStartingNode="true" />
                                    <asp:SiteMapPath ID="SiteMapPath1" runat="server" CssClass="style1" RootNodeStyle-Font-Bold="true" CurrentNodeStyle-Font-Bold="true" Font-Bold="true" NodeStyle-Font-Bold="true" >
                                                   ...
                                                   <asp:GridView ID="GrdCourseApply" AutoGenerateColumns="false" runat="server" DataKeyNames="stid"  Width="100%" AllowPaging="true" PageSize="10" CssClass="table form_body">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Course Title" ItemStyle-HorizontalAlign="Center" >
                                                           ...
                                                           <asp:TemplateField HeaderText="View Material" ItemStyle-HorizontalAlign="Center" >
                                                            <ItemTemplate>
                                                                <a id="a1" href="ListContent.aspx?id=<%#Container.DataItem("courseID")%>&sid=<%#Container.DataItem("stid")%>">
                                                                    view </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="View Material With Add Note" ItemStyle-HorizontalAlign="Center" >
                                                            <ItemTemplate>
                                                                <a id="a1" href="CourseMaterial.aspx?id=<%#Container.DataItem("courseID")%>&sid=<%#Container.DataItem("stid")%>">
                                                                    view with Add Note </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
