<%@ Control Language="VB" AutoEventWireup="false" CodeFile="MainHeader.ascx.vb" Inherits="MainHeader" %>
 <style type="text/css">
        .menuItem
        {
...
<table>
   <tr>
                           ...
                           <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="../../download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0"
                                    ...
                                    <!--[if !IE]> <-->
                                    <object data="images/menu_top.swf" width="703" height="70" type="application/x-shockwave-flash">
                                        <param name="quality" value="high">
                                        <param name="menu" value="false">
