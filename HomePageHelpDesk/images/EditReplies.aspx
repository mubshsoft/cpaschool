...
input[type=checkbox], input[type=radio] {
    ...
    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12"><b>Topic :-&nbsp;&nbsp;
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><asp:Button ID="imgBack" runat="server" cssclass="btn btn-primary" text="Back to Topics" /></div>
                                        </div>
                                    <div class="row">&nbsp;</div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                        
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                       <ItemTemplate>
                          <asp:Button ID="lnkDelete" runat="server" CommandName="Delete" CssClass="btn btn-primary" CommandArgument='<%# Eval("subsubjectid") %>' OnClientClick ="return confirm('Are you sure you want to delete?')" text="Delete" />
                       </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
