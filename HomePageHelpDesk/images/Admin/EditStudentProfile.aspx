<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="EditStudentProfile.aspx.vb" Inherits="Admin_EditStudentProfile" Title="Edit Student Profile" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
                 ...
                 <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" ><asp:TextBox ID="txtCourseTitle" runat="server" CssClass="input-block-level" MaxLength="48" Enabled="False" ></asp:TextBox></div>
                 </div>
                 </div>
                 ...
                 <div class="row" style="margin-top: 20px;">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" ><asp:TextBox ID="txtEmailAddress" runat="server" CssClass="input-block-level" Enabled="false" MaxLength="50"></asp:TextBox></div>
                             </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 form_text field-label">Email for correspondence :</div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtSecondaryEmail" runat="server" CssClass="input-block-level" MaxLength="50" ></asp:TextBox></div>
                 </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 form_text field-label">Password :</div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtPassword" runat="server" CssClass="input-block-level" MaxLength="50" ></asp:TextBox></div>
                 </div>
                 </div>
                 <div class="user-info media box" style="background-color:#fff;">
                 <div class="row">
                 ...
                 <div class="row" style="margin-top: 20px;">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtFirstName" runat="server" CssClass="input-block-level" MaxLength="49" ></asp:TextBox></div>
                </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 form_text field-label">Middle Name :</div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtMiddleName" runat="server" CssClass="input-block-level" MaxLength="49" ></asp:TextBox></div>
                </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 form_text field-label">Last Name :</div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtLastName" runat="server" CssClass="input-block-level" MaxLength="49" ></asp:TextBox></div>
                </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 form_text field-label">Date of Birth :</div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtDOB" runat="server" CssClass="input-block-level" MaxLength="10" ></asp:TextBox></div>
                </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 form_text field-label">Permanent Address :</div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtPermanentAddress" runat="server" CssClass="input-block-level" TextMode="MultiLine" Rows="4"></asp:TextBox></div>
                </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 form_text field-label">Correspondence Address :</div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtCorrespondenceAddress" runat="server" CssClass="input-block-level" TextMode="MultiLine" MaxLength="100" Rows="4"></asp:TextBox></div>
                </div>
                <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtContactNumber" runat="server" 
                                                                CssClass="input-block-level" MaxLength="20"  ></asp:TextBox>
                ...
                <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtMobileNumber" runat="server" CssClass="input-block-level" MaxLength="20" ></asp:TextBox>
                ...
                <div class="row">
                 ...
                 <div class="row" style="margin-top: 20px;">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:DropDownList ID="dllGender" runat="server" CssClass="input-block-level">
                 ...
                 <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:DropDownList ID="ddlapplicantCategory" runat="server" CssClass="input-block-level">
                 ...
                 <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:DropDownList ID="dllProfession" runat="server" CssClass="input-block-level">
                 ...
                 <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:DropDownList ID="dllCountry" runat="server" CssClass="input-block-level">
                 ...
                 <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:DropDownList ID="dllCategory" runat="server" CssClass="input-block-level">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtStream1" runat="server" Title="10th" placeholder="10th" CssClass="input-block-level" MaxLength="100"></asp:TextBox></div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtStream2" runat="server" Title="12th" placeholder="12th" CssClass="input-block-level" MaxLength="100"></asp:TextBox></div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtStream3" runat="server" Title="Graduation" placeholder="Graduation" CssClass="input-block-level" MaxLength="100"></asp:TextBox></div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtStream4" runat="server" Title="Any Other" placeholder="Any Other" CssClass="input-block-level" MaxLength="100"></asp:TextBox></div>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
    <div class="row">
    ...
    <div class="row" style="margin-top: 20px; border-bottom:solid 1px #c0c0c0; margin-bottom:10px">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><asp:TextBox ID="txtTotExp" runat="server" placeholder="Total Years of Experience" CssClass="input-block-level" MaxLength="4"></asp:TextBox>
            </div>
    </div>
    <div class="row">
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
    ...
    <div class="user-info media box" style="background-color:#fff;">
     ...
     <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtPlace" runat="server" CssClass="input-block-level" MaxLength="40" Width="100%" placeholder="Place"></asp:TextBox></div>
    </div>
    <div class="row">&nbsp;</div>
