<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="ManagebatchByAdmin.aspx.vb" Inherits="Admin_ManagebatchByAdmin" Title="Manage Batch" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <section class="container main m-tb">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                          <ContentTemplate >
                                                            <asp:DropDownList ID="ddlBatch" runat="server" AutoPostBack="true" ToolTip="Batch Code" CssClass="input-block-level">
                                                            </asp:DropDownList>
                                                             </ContentTemplate>
                                    </asp:UpdatePanel>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                     <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                          <ContentTemplate >
                                                <asp:GridView ID="GrdStudent" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table"
                                                    runat="server" AllowPaging="True" PageSize="5" OnPageIndexChanging="GrdStudent_PageIndexChanging" OnRowCommand="GrdStudent_RowCommand" OnRowDeleting="GrdStudent_RowDeleting">
