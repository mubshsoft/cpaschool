<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="AddCourse.aspx.vb" Inherits="Admin_AddCourse" Title="Course Info" %>
...
input[type=checkbox], input[type=radio] {
   ...
   <asp:Label ID="lblCaption" Visible="false" runat="server" />
    ...
    <div class="user-info media box" style="background-color:#fff;">
                ...
                <div class="row">&nbsp;</div>
                <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center" align="center"><asp:Button ID="ImageButton1" runat="server" Text="Back" CssClass="btn btn-primary btn-large"   /> <asp:Button ID="btnSave" runat="server"  Text="Save & Continue" CssClass="btn btn-success btn-large" /></div>
                </div>
               </div>
