<%@ Page MasterPageFile="~/HomeMaster-new.master"Language="VB" AutoEventWireup="false" CodeFile="ManageStudentPromotion.aspx.vb"
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="row">   
                                  ...
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                ...
                                                                <div class="row">
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlSemListStudent" runat="server" CssClass="input-block-level" ToolTip="Select Semester to list student" AutoPostBack=true>
                                                                    </asp:DropDownList></div>
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlsem" runat="server" CssClass="input-block-level" ToolTip="Select Semester to Promote">
                                                                    </asp:DropDownList></div>
                                  </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center">
                                                ...
                                                <asp:Button ID="btncancel" Text="Cancel" CssClass="btn btn-large btn-primary" runat="server" />
                                            </div>
                                            <div class="row">&nbsp;</div>
                                            <hr />
                                            </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <asp:GridView ID="GrdBatchStatus" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table"
