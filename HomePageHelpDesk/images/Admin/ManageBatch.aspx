<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="ManageBatch.aspx.vb" Inherits="Admin_ManageBatch" Title="Manage Batch" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <section class="container main m-tb">
                ...
                <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <span class="pull-right"><asp:LinkButton ID="AddNew" runat="server" Text="Create New batch" CssClass="btn btn-success btn-large" Visible="true" ></asp:LinkButton></span>
                </div>
                </div> 
                <div class="row">&nbsp;</div>
                <div class="row">
              ...
              runat="server" />Select All</HeaderTemplate>
                                                            <ItemTemplate>
