<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster-new.master" AutoEventWireup="true" CodeFile="KnowledgecenterList.aspx.cs" Inherits="Admin_KnowledgecenterList" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <span class="pull-right"><asp:Button ID="add" runat="server" Text="Add Knowledge Center" CssClass="btn btn-large btn-primary" PostBackUrl="~/Admin/Knowledgecenter.aspx" /></span>
          </div></div>
