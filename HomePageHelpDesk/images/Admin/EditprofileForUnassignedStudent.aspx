<%@ Page Language="VB" MasterPageFile="~/HomeMaster-new.master" AutoEventWireup="false" CodeFile="EditprofileForUnassignedStudent.aspx.vb" Inherits="Admin_EditprofileForUnassignedStudent" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <div class="col-lg-11 col-md-11 col-sm-12 col-xs-12"><asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                          <ContentTemplate ><asp:TextBox ID="txtfirstname" runat="server" placeholder="Enter search contents" CssClass="input-block-level"></asp:TextBox>
  ...
  <div class="user-info media box" style="background-color:#fff;">                                       
                     <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow:auto">                   
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                          <ContentTemplate>
                                                 <asp:GridView ID="GrdStudent" AutoGenerateColumns="False" DataKeyNames="stid" runat="server" AllowPaging="True" OnPageIndexChanging="grdView_PageIndexChanging" CssClass="table" >
