<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AddExamSet.aspx.cs" Inherits="Admin_AddExamSet" Title="Add ExamSet" %>
...
<asp:TextBox ID="txtexamcode" runat="server" ToolTip="Exam Code" PlaceHolder="Exam Code" CssClass="input-block-level"></asp:TextBox>
...
<asp:DropDownList ID="ddlCourse" AutoPostBack="true" runat="server" ToolTip="Course Code" CssClass="input-block-level" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" />
   <asp:Label ID="lblreqcourse" runat="server" Text="" ForeColor="Red"></asp:Label>
    ...
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlSem" AutoPostBack="true" runat="server" ToolTip="Semester" CssClass="input-block-level" OnSelectedIndexChanged="ddlSem_SelectedIndexChanged" />
     <asp:Label ID="lblreqsem" runat="server" Text="" ForeColor="Red"></asp:Label>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlModule" AutoPostBack="true" runat="server" ToolTip="Module" CssClass="input-block-level" OnSelectedIndexChanged="ddlModule_SelectedIndexChanged" />
      <asp:Label ID="lblreqmodule" runat="server" Text="" ForeColor="Red"></asp:Label>
    </div>
    </div>
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlPaper" runat="server" ToolTip="Paper" CssClass="input-block-level" />
   ...
   <div class="user-info media box" style="background-color:#fff;">
       <legend>View existing exam</legend>
        <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlcoursefillter" runat="server" AutoPostBack="True" ToolTip="Course" CssClass="input-block-level" OnSelectedIndexChanged="ddlcoursefillter_SelectedIndexChanged"></asp:DropDownList>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
