<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AddEvaluationCriteria.aspx.cs" Inherits="AddEvaluationCriteria" Title="Add Evaluation Criteria" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtColumn1" runat="server" placeholder="Marks1 Column Name" ToolTip="Marks1 Column Name" CssClass="input-block-level" ></asp:TextBox></div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtColumn2" runat="server" placeholder="Marks2 Column Name" ToolTip="Marks2 Column Name" CssClass="input-block-level" ></asp:TextBox></div>
    </div>
    <div class="row" >
