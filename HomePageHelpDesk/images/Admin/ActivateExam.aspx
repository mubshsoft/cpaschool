<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ActivateExam.aspx.cs" Inherits="ActivateExam" Title="Activate Exam" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="row" ><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlexamset" runat="server" ToolTip="Exam Set" CssClass="input-block-level" AutoPostBack="True" OnSelectedIndexChanged="ddlexamset_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlbatch" runat="server" ToolTip="Batch Code" CssClass="input-block-level"></asp:DropDownList>
                            </div>
     </div>                            
    <div class="row" ><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtactivateDate" runat="server" ToolTip="Activation Date" placeholder="Activation Date" CssClass="input-block-level"></asp:TextBox>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtDeactivateDate" runat="server" ToolTip="Deactivation Date" placeholder="Deactivation Date" CssClass="input-block-level"></asp:TextBox>
                            <a href="javascript:NewCal('<%= txtDeactivateDate.ClientID %>','mmddyyyy')"> <img src="../images/calender.png" width="22" height="22" border="0" alt="Pick a date" style="vertical-align:bottom"></a>
     ...
     <div class="row" ><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlcoursefillter" runat="server" AutoPostBack="True" placeholder="Course" CssClass="input-block-level" OnSelectedIndexChanged="ddlcoursefillter_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlyear" runat="server" AutoPostBack="True" placeholder="Year" CssClass="input-block-level" OnSelectedIndexChanged="ddlyear_SelectedIndexChanged" >
...
<div class="user-info media box" style="background-color:#fff;">
 <div class="row" ><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow:auto"> 
                                                        <asp:GridView ID="grdExamSet" runat="server" AutoGenerateColumns="False" PageSize="20" CssClass="table"
