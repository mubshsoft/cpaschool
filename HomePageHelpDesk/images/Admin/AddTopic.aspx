<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="AddTopic.aspx.vb" Inherits="Admin_AddTopic" ValidateRequest="false" Title="Topic Info" %>
...
input[type=checkbox], input[type=radio] {
  ...
  <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <div class="well">
    <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtTopic" runat="server" ToolTip="Topic" CssClass="input-block-level" ></asp:TextBox></div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtcreatedby" runat="server" ToolTip="Created by" CssClass="input-block-level"  Enabled="false" ></asp:TextBox></div>
    </div>
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                          <ContentTemplate >
                                                            <asp:Dropdownlist ID="ddlCourse" runat="server" CssClass="input-block-level" ToolTip="Course" AutoPostBack="true"></asp:Dropdownlist>
                                                        </ContentTemplate>
    </asp:UpdatePanel></div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                          <ContentTemplate >
                                                            <asp:Dropdownlist ID="ddlBatch" runat="server" CssClass="input-block-level" ToolTip="Batch"></asp:Dropdownlist>
                                                              </ContentTemplate>
    </asp:UpdatePanel></div>
    </div>
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                          <ContentTemplate >
                                                            <asp:Dropdownlist ID="ddlSem" runat="server" CssClass="input-block-level" ToolTip="Semester"></asp:Dropdownlist>
                                                              </ContentTemplate>
    </asp:UpdatePanel></div>
