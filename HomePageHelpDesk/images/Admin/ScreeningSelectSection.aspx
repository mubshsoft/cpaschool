<%@ Page  MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ScreeningSelectSection.aspx.cs" Inherits="Admin_ScreeningSelectSection" Title="Section Info" %>
    ...
    <section class="container main m-tb">
     <div class="user-info media box" style="background-color:#fff;">
       ...
       <asp:GridView ID="gvCategoryList" runat="server"  AutoGenerateColumns="false" DataKeyNames="CategoryID" 
                                                    ...
                                                    Width="100%" CssClass="table" onrowcommand="gvCategoryList_RowCommand" 
        ...
        <div class="row">
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:HiddenField ID="hdnScrId" runat="server" /></div>
        </div>
        </div>
        </section>
    </div>
