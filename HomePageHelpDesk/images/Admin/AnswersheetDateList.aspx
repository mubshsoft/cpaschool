<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="AnswersheetDateList.aspx.vb"
    Inherits="Admin_AnswersheetDateList" %>
...
<div class="user-info media box" style="background-color:#fff;">
    ...
    <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlListExamSet" runat="server" AutoPostBack="true" ToolTip="ExamSet code" CssClass="input-block-level">
...
<div class="user-info media box" style="background-color:#fff;">
        <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow:auto">
                                                        <asp:GridView ID="GrdUserList" AutoGenerateColumns="False" OnRowDataBound="GrdUserList_RowDataBound" Width="100%" runat="server" CssClass="table"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Sent  Date" ItemStyle-HorizontalAlign="Center"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblsentdt" runat="server" ></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Receive Date" ItemStyle-HorizontalAlign="Center"
                                                                    ItemStyle-Width="250px">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblreceivedt" runat="server" ></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
