<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ShowScreening.aspx.cs" Inherits="Admin_ShowScreening" EnableEventValidation="false" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <h1 class="heading-color">Show Screening</h1> 
    <div class="breadcrumbs">
		<ul class="clearfix">
        <li><a href="../Admin/Adminlogin.aspx">Admin Panel</a></li>
        <li class="active">Show Screening</li>
		</ul>
	</div>
    </section>
    ...
    <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="pull-right"><asp:Button ID="ImageButton1" runat="server" Text="Print" CssClass="btn btn-large btn-primary" ToolTip="Print" />
                                <asp:Button ID="ImgBack" runat="server" Text="Back" CssClass="btn btn-large btn-warning" ToolTip="Back" OnClick="ImgBack_Click" /></span></div>
     </div>                    
      <div class="row">&nbsp;</div>
      <div class="row">
                                                                                                    ...
                                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                                        <tr>
                                                                                                            <td align="center" class="text1">
                                                                                                                            <h4><asp:Label ID="lblSection" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "CategoryName")%>'
                                                                                                                                VerticalAlign="Top" ></asp:Label></h4>
