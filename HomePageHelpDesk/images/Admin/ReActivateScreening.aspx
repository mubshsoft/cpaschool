<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="ReActivateScreening.aspx.vb" Inherits="Admin_ReActivateScreening" Title="Reactivate Screening" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     <div class="row">
      ...
      <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlcourse" runat="server" AutoPostBack="true" ToolTip="Course" CssClass="input-block-level"></asp:DropDownList></div>
    </div>
      <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlScreeningset" runat="server" AutoPostBack="true"  ToolTip="Screening Code" CssClass="input-block-level"></asp:DropDownList></div>
        </div>
        <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlyear" runat="server" AutoPostBack="true" ToolTip="Year" CssClass="input-block-level">
