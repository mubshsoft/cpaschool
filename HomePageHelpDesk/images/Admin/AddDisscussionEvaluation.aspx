<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="AddDisscussionEvaluation.aspx.vb" Inherits="Admin_AddDisscussionEvaluation" Title="Marks" %>
                                                    ...
                                                    <Columns>
                                                     <asp:TemplateField HeaderText="Student Id" Visible="false"  ItemStyle-HorizontalAlign="Left">
                                                        ...
                                                        <asp:TemplateField HeaderText="Project Marks" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtProMarks" Text='<%# Eval("Project") %>' runat="server" CssClass="input-block-level" ></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Marks 1" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtMarks1" Text='<%# Eval("marks1") %>' runat="server" CssClass="input-block-level" ></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Marks 2" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtMarks2" Text='<%# Eval("marks2") %>' runat="server" CssClass="input-block-level" ></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
