<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AssignmentStudentInstructionSummary.aspx.cs" Inherits="Admin_AssignmentStudentInstructionSummary" ValidateRequest="false" Title="Instruction Summary"  %>
...
<section class="fullwidth banner-color">
    ...
    <FTB:FreeTextBox ID="txtInstruction" Width="100%" runat="server"></FTB:FreeTextBox>
    </div>
    </div>
    <div class="row" >&nbsp;</div>
    <div class="row" >
