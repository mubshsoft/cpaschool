<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="CourseList.aspx.cs" Inherits="CourseList" Title="Course List" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <span class="pull-right"><asp:Button ID="add" runat="server" Text="Add Course Detail" CssClass="btn btn-large btn-primary" PostBackUrl="~/Admin/AddCourseDetails.aspx" /></span>
          </div></div>
    <div class="row">&nbsp;</div>                                         
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:LinkButton ID="linkAddOption" runat="server" CausesValidation="false" Font-Underline="false" Text="Edit"> 
                                                                        </asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField>
