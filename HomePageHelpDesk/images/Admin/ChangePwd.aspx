<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ChangePwd.aspx.cs" Inherits="Admin_ChangePwd" Title="Change Password" %>
...
<div>
 ...
 <section class="container main m-tb">
    ...
    <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="pull-right"><asp:button ID="btnback" Text="Back" CssClass="btn btn-large btn-primary" runat="server" onclick="btnback_Click" /></span></div>
    </div>
    <div class="user-info media box" style="background-color:#fff;">
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <asp:DropDownList ID="ddlCourse" runat="server" CssClass="input-block-level" ToolTip="Course" AutoPostBack="True" onselectedindexchanged="ddlCourse_SelectedIndexChanged"></asp:DropDownList></div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <asp:DropDownList ID="ddlbatch" runat="server" CssClass="input-block-level" ToolTip="Batch Code" AutoPostBack="True" onselectedindexchanged="ddlbatch_SelectedIndexChanged" meta:resourcekey="ddlbatchResource1"></asp:DropDownList></div>
    </div>
    </div>
    <div class="user-info media box" style="background-color:#fff;">
    <div class="row" >
...
<asp:TemplateField HeaderText="First Name" 
    ...
    <EditItemTemplate>
        <asp:TextBox ID="txtFirstName" runat="server" CssClass="input-block-level" Text='<%# Bind("FirstName") %>' 
...
<asp:TemplateField HeaderText="Last Name" 
    ...
    <EditItemTemplate>
        <asp:TextBox ID="txtLastName" runat="server" CssClass="input-block-level" Text='<%# Bind("LastName") %>' 
...
<asp:TemplateField HeaderText="Password" 
    ...
    <EditItemTemplate>
        <asp:TextBox ID="txtPassword" CssClass="input-block-level" runat="server" Text='<%# Bind("Password") %>' 
