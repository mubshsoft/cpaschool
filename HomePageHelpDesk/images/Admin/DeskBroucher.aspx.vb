...
Partial Class Admin_DeskBroucher
    ...
    Sub BindGrid()
        ...
        Try
            Dim strq As String = "select cs.*,br.HelpDeskFilepath,br.BroucherFilepath,br.CalendarFilepath from course cs INNER JOIN HelpDeskBroucher br on br.courseid=cs.courseid"
