<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="ListStudentForEditprofile.aspx.vb" Inherits="Admin_ListStudentForEditprofile" Title="List of students" %>
...
<div class="user-info media box" style="background-color:#fff;">
    <div class="row">
    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11"><asp:TextBox ID="txtfirstname" runat="server" CssClass="input-block-level"></asp:TextBox></div>
    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-primary btn-large" style="margin: 10px 0;"  /></div>
    </div>
    <div class="row">
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                          <ContentTemplate >
                                                  <asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="true" CssClass="input-block-level" ToolTip="Course Code" ></asp:DropDownList>
...
<asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                          <ContentTemplate >
                                                  <asp:DropDownList ID="ddlbatch" runat="server" AutoPostBack="true" CssClass="input-block-level" ToolTip="Batch" ></asp:DropDownList>
                                                  </ContentTemplate>
                                                  </asp:UpdatePanel>
    </div></div>
</div>
 ...
 <div class="user-info media box" style="background-color:#fff;">                                      
                     <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                   
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                          <ContentTemplate>
                                                 <asp:GridView ID="GrdStudent" AutoGenerateColumns="False" DataKeyNames="stid" runat="server" PageSize="10" AllowPaging="True" OnPageIndexChanging="grdView_PageIndexChanging" CssClass="table" >
                                                                                                             ...
                                                                                                             <asp:TemplateField  HeaderText="Email" ItemStyle-HorizontalAlign="Left">
                                                                                                                ...
                                                                                                                <asp:TemplateField>
                                                                                                                    <ItemTemplate>
                                                                                                                        ...
                                                                                                                        <a id="a3" href="EditStudentProfile.aspx?id=<%#Container.DataItem("stid")%>&cid=<%#Container.DataItem("courseid") %>&bid=<%#Container.DataItem("bid") %>" class="btn btn-primary">
                                                                                                                           Details</a>
                                                                                                                    </ItemTemplate>
                                                                                                                </asp:TemplateField>
