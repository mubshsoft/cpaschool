<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AddScreeningSet.aspx.cs"
                                                    ...
                                                    <ContentTemplate>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <div class="user-info media box" style="background-color:#fff;">
                                                                        ...
                                                                        <div class="row">
                                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtScreeningcode" runat="server" ToolTip="Screening Code" placeholder="Screening Code" CssClass="input-block-level"></asp:TextBox>
                                                                                    <asp:Label ID="lblreqScreeningcode" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                                                    </div>
                                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlCourse" AutoPostBack="true" runat="server" ToolTip="Course Code" placeholder="Course Code" CssClass="input-block-level" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" />
                                                        ...
                                                        <td align="left" >
                                                          <asp:DropDownList ID="ddlScreeningType"  runat="server" 
                                                              ...
                                                              <asp:ListItem>Online</asp:ListItem>
                                                                        ...
                                                                        <div class="row">
                                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="tronline" runat="server"><asp:TextBox ID="txtTimeAllowted" runat="server" ToolTip="Time alloted" placeholder="Time alloted" CssClass="input-block-level"></asp:TextBox>
                                                                    ...
                                                                    <div class="user-info media box" style="background-color:#fff;">
                                                                        ...
                                                                        <div class="row">
                                                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlyear" runat="server" AutoPostBack="True" ToolTip="Year" CssClass="input-block-level" OnSelectedIndexChanged="ddlyear_SelectedIndexChanged" >
