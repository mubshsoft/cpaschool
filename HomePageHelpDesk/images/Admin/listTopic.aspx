<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="listTopic.aspx.vb" Inherits="Admin_listTopic" Title="List Topic" %>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:Label ID="lblMessage" EnableViewState="false" runat="server" Text="" ForeColor="Red"></asp:Label></div>
     ...
     <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlCourse" runat="server" ToolTip="Course" AutoPostBack="true" CssClass="input-block-level"></asp:DropDownList></div>
    </div>
    <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlBatch" runat="server" ToolTip="Batch" AutoPostBack="true" CssClass="input-block-level"></asp:DropDownList></div>
    </div>
    <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlsem" runat="server" ToolTip="Semester" CssClass="input-block-level" AutoPostBack="true"></asp:DropDownList></div>
    </div>
    <div class="row" >
