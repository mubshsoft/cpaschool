reac<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ActvateCaseStudy_StudentList.aspx.cs" Inherits="Admin_ActvateCaseStudy_StudentList" %>
    ...
    <div class="span12">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Email "><%--<ItemStyle Width="110px" />--%>
                                                          ...
                                                          <asp:TemplateField HeaderText="Code "><%--<ItemStyle Width="110px" />--%>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblexamcode" runat="server" 
                                                                    Text='<%#DataBinder.Eval(Container.DataItem, "CSCode")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
