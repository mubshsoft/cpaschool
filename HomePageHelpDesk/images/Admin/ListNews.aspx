<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="ListNews.aspx.vb" Inherits="Admin_ListNews" Title="List of News" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <section class="container main m-tb">
     ...
     <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="pull-right"><asp:Button ID="add" runat="server" Text="Add News" CssClass="btn btn-large btn-primary" PostBackUrl="~/Admin/Addnews.aspx" /></span></div>
    </div>
