<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster-new.master" AutoEventWireup="true" CodeFile="Knowledgecenter.aspx.cs" Inherits="Admin_Knowledgecenter" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:Label ID="lblMessage" EnableViewState="false" runat="server" Text="" ForeColor="Red"></asp:Label></div></div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtURL" runat="server" CssClass="input-block-level" placeholder="https://www.youtube.com/" TabIndex="3"></asp:TextBox></div>
      </div>
      </div>
       <div class="row" >
