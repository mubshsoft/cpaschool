<%@ Page Language="C#" MasterPageFile="~/HomeMaster-new.master" AutoEventWireup="true" CodeFile="AssignExamToFaculty.aspx.cs" Inherits="Admin_AssignExamToFaculty" %>
...
<section class="fullwidth banner-color">
    ...
    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlFaculty" runat="server" CssClass="input-block-level"></asp:DropDownList></div>
    </div>
    <div class="row">&nbsp;</div>
     <div class="row" >
