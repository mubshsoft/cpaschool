...
<div class="user-info media box" style="background-color:#fff;">
                                  ...
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:Label ID="lblMessage" EnableViewState="false" runat="server" Text="" ForeColor="Red"></asp:Label></div></div>
                                   <div class="row">
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="true" CssClass="input-block-level" ToolTip="Select Course"></asp:DropDownList></div>
                                  </div>
                                   <div id="trbatch" runat="server" class="row" visible="false">
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" ><asp:DropDownList ID="ddlbatch" runat="server" AutoPostBack="true" CssClass="input-block-level" ToolTip="Select Batch"></asp:DropDownList></div>
                                  </div>
</div>
<div class="row">&nbsp;</div>
                                   <div class="row">
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center">
                                   <asp:Button ID="btnback" runat="server" Text="Back" CssClass="btn btn-primary btn-large "  />
                                  </div>
                                  </div>    
