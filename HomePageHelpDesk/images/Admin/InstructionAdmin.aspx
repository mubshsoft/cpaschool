<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="InstructionAdmin.aspx.cs" Inherits="InstructionAdmin" EnableEventValidation="false" %>
...
<section class="fullwidth banner-color">
    <h1 class="heading-color">Exam Answer Sheet</h1> 
    <div class="breadcrumbs">
		<ul class="clearfix">
        <li><a href="Adminlogin.aspx"><font color="#fff">Admin Panel</font></a></li>
       <li class="active">Exam Answer Sheet</li>
		</ul>
	</div>
    </section>
  ...
  <section class="container main m-tb">
        ...
        <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="pull-right">
         <asp:Button ID="ImageButton1" runat="server" Text="Print" CssClass="btn btn-large btn-success" ToolTip="Print" />
