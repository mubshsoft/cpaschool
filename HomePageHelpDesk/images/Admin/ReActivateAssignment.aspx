<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="ReActivateAssignment.aspx.vb" Inherits="Admin_ReActivateAssignment" Title="Re Activate Assignment" %>
...
<head id="Head1" runat="server">
    ...
    <title>Re Activate Assignment</title>--%>
...
<section class="fullwidth banner-color">
    <h1 class="heading-color">Re Activate Assignment</h1> 
    <div class="breadcrumbs">
		<ul class="clearfix">
        <li><a href="Adminlogin.aspx">Admin Panel</a></li>
        <li class="active">Re Activate Assignment</li>
		</ul>
	</div>
    </section>
     ...
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow:auto">
                                                <asp:GridView ID="GrdStudent" AutoGenerateColumns="False" DataKeyNames="id" Width="100%" CssClass="table"
                                                    ...
                                                    <Columns>
                                                     ...
                                                     <asp:TemplateField HeaderText="AsgnId" Visible="false"  ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblAsgnId" Text='<%# Eval("AsgnId") %>' runat="server"
                                                                    CssClass="left_padding"></asp:Label>
                                                            </ItemTemplate>
                                                       </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField >
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkActivate" runat="server" CommandName="Update" CommandArgument='<%# Eval("Id") %>' OnClientClick ="return confirm('Are you sure you want to Re-Activate Assignment ?')">Activate Assignment</asp:LinkButton>
