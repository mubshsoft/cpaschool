<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AddClosure.aspx.cs" Inherits="Admin_AddClosure" Title="Closure Entry" %>
...
<div class="row" >
    ...
    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6"><asp:TextBox ID="txtTestimonialsDate" runat="server" Width="110px" CssClass="input-block-level" ></asp:TextBox>&nbsp;&nbsp;
    ...
    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6"><asp:TextBox ID="txtTestiomonialStudent" runat="server" Width="110px" CssClass="input-block-level"></asp:TextBox>&nbsp;&nbsp;
...
<div class="row" >
    ...
    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6"><asp:TextBox ID="txtDispatchedDate" runat="server" Width="110px" CssClass="input-block-level"></asp:TextBox>&nbsp;&nbsp;
...
<div class="col-lg-2 col-md-2 col-sm-6 col-xs-6"><asp:TextBox ID="txtCertificateStudent" runat="server" Width="110px" CssClass="input-block-level"></asp:TextBox>&nbsp;&nbsp;
