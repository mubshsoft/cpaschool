<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="ListCourseHelp.aspx.vb" Inherits="Admin_ListCourseHelp" %>
                                                ...
                                                <asp:GridView ID="GrdCourse" AutoGenerateColumns="False" DataKeyNames="CourseId" Width="100%" CssClass="table"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="CourseTitle" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblStudentFirstName" Text='<%# Eval("CourseTitle") %>' runat="server"
