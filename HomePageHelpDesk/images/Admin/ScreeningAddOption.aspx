<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ScreeningAddOption.aspx.cs" Inherits="Admin_ScreeningAddOption" Title="Course Information" %>
  ...
  <asp:UpdatePanel ID="update1" runat="server"><ContentTemplate>
    ...
    <div class="user-info media box" style="background-color:#fff;">
       ...
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><strong>Question:<asp:Label ID="lblQuestion" runat="server" Text=""></asp:Label></strong></div>
        ...
        <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlOptionType" runat="server" TabIndex="2" CssClass="input-block-level" ToolTip="Option Type">
...
<%--<asp:Label ID="lblCountry" runat="server" Text="Option Type :"></asp:Label>--%>
           <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtoption" runat="server" TabIndex="3" CssClass="input-block-level" ToolTip="Add option" ></asp:TextBox><font color="red">*</font>
