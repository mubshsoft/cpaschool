<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ScreeningAddSelectSection.aspx.cs" Inherits="Admin_ScreeningAddSelectSection" Title="Section Info" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     <div class="row">
      ...
      <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:TextBox ID="txtNoofSection" placeholder="No. of Section" ToolTip="No. of Section" CssClass="input-block-level" runat="server"></asp:TextBox></div>
                </div>
        ...
        <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                              <asp:GridView ID="gvCategoryList" runat="server"  AutoGenerateColumns="false" DataKeyNames="CategoryID" 
                                                    ...
                                                    OnRowDataBound="gvCategoryList_RowDataBound"  CssClass="table"
                                                   
                                                    Width="100%" onrowcommand="gvCategoryList_RowCommand" 
                                                        ...
                                                        <asp:TemplateField Visible="false">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="linkDeleteCategory" runat="server" CommandName="Delete" 
                                                                    Font-Underline="false">Add Question</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         ...
                                                         <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="linkaddcategoryquestion" runat="server" CommandName="add" 
                                                                    Font-Underline="false">Add Detail for section</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                       <asp:TemplateField>
                                                                 <ItemTemplate>
                                            ...
                                            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:HiddenField ID="hdnScrId" runat="server" /></div></div>
                </div>
                </section>
