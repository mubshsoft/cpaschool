<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ScreeningActivateExam.aspx.cs" Inherits="Admin_ScreeningActivateExam" Title="Use Existing Screening" %>
...
<iframe name="popFrame" src="../UNTITLED.htm" frameborder="0" scrolling="no" width="152" height="147"></iframe>
    ...
    <div class="user-info media box" style="background-color:#fff;">
       ...
       <div class="row">
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlScreeningset" runat="server"  CssClass="input-block-level" ToolTip="Screening Set" AutoPostBack="True" onselectedindexchanged="ddlScreeningset_SelectedIndexChanged"></asp:DropDownList></div>
        </div>
        <div class="row">
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtactivateDate" runat="server" CssClass="input-block-level" ToolTip="Activation Date" placeholder="Activation Date"></asp:TextBox>
       ...
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtDeactivateDate" runat="server" CssClass="input-block-level" ToolTip="Deactivation Date" placeholder="Deactivation Date"></asp:TextBox>
