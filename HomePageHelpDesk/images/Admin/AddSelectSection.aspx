<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AddSelectSection.aspx.cs" Inherits="Admin_AddSelectSection" Title="Section Info" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
     ...
     <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                               
         <asp:TextBox ID="txtNoofSection" ToolTip="No. of Section" placeholder="No. of Section" CssClass="input-block-level" runat="server"></asp:TextBox>
         </div></div>
