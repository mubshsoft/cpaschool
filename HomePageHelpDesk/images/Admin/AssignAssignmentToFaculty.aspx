<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignAssignmentToFaculty.aspx.cs" Inherits="Admin_AssignAssignmentToFaculty" %>
    ...
    <form id="form1" runat="server">
     <div onkeypress="javascript:HideMessage()">
                                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td style="padding-top:20px;padding-bottom:20px;padding-left:10px; font-size:large; text-align:center  "><strong> Assign Assignment to faculty</strong></td>
                                        </tr>
                                         <tr>
