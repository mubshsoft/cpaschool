<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ScreeningAddQuestion.aspx.cs" Inherits="Admin_ScreeningAddQuestion" Title="Add Question" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
       ...
       <div class="row">
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><h4><asp:Label ID="lblSection" runat="server" Text="" ></asp:Label></h4></div>
       </div>
       <div class="row">
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
       <asp:DropDownList ID="ddlQuestionType" runat="server" AutoPostBack="true" CssClass="input-block-level" ToolTip="Question Type" TabIndex="1" OnSelectedIndexChanged="ddlQuestionType_SelectedIndexChanged">
       ...
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtQuestion" runat="server" TextMode="MultiLine" ToolTip="Question" TabIndex="2" CssClass="input-block-level"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="rqdSurveyQuestion" runat="server" ControlToValidate="txtQuestion" Display="Dynamic" ErrorMessage="Enter  Question " ValidationGroup="1"></asp:RequiredFieldValidator>
                          <FCKeditorV2:FCKeditor ID="Editor1" runat="server" BasePath="~/fckeditor/" Height="200px" Visible="false"></FCKeditorV2:FCKeditor>
                                                       </div>
    </div>
    <div class="row">
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtAnswer" runat="server" TabIndex="3" CssClass="input-block-level" ToolTip="Answer" placeholder="Answer"></asp:TextBox></div>
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtMarks" runat="server" TabIndex="4" CssClass="input-block-level" ToolTip="Marks" placeholder="Marks"></asp:TextBox>
                                                            <nobr> 
            ...
            <div class="row">
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="trup1" runat="server" visible="false"><asp:FileUpload ID="FileUpload1" ToolTip="upload Image" runat="server" /></div>
       </div>
            ...
            <div class="row">&nbsp;</div>
            <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center"><asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btn btn-large btn-warning" OnClick="btnBack_Click" CausesValidation="false" />
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:HiddenField ID="hdnScrId" runat="server" />
 ...
 <div class="row">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:HiddenField ID="hdneditorupdate" runat="server" Value="0" />
