<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="ReActivateExam.aspx.vb" Inherits="Admin_ReActivateExam" Title="Re Activate Exam" %>
  ...
  <section class="container main m-tb">
    <div class="user-info media box" style="background-color:#fff;">
        ...
        <div class="row"><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlcourse" runat="server" AutoPostBack="true" ToolTip="Course" CssClass="input-block-level">
                               ...
                               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlBatch" runat="server" AutoPostBack="True" ToolTip="Batch Code" CssClass="input-block-level" ></asp:DropDownList>
                               </div>
        </div>
        <div class="row"><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlexamset" runat="server" AutoPostBack="true" ToolTip="Exam Code" CssClass="input-block-level">
                                                    </asp:DropDownList>
                                </div>
