<%@ Page Language="VB" MasterPageFile="~/HomeMaster-new.master" AutoEventWireup="false" CodeFile="ApplyAnotherCourse.aspx.vb" Inherits="Admin_ApplyAnotherCourse" %>
...
input[type=checkbox], input[type=radio] {
 ...
 <section class="container main m-tb">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:Label ID="lblMessage" EnableViewState="false" runat="server" Text="" ForeColor="Red"></asp:Label></div>
        ...
        <div class="row">
    <div class="col-lg-11 col-md-11 col-sm-12 col-xs-12"><asp:TextBox ID="txtfirstname" runat="server" placeHolder="Type Name or Email" CssClass="input-block-level"></asp:TextBox></div>
