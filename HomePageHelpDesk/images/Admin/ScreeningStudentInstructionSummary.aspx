<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ScreeningStudentInstructionSummary.aspx.cs" Inherits="Admin_ScreeningStudentInstructionSummary" ValidateRequest="false" Title="Instruction Summary"  %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
       ...
       <FTB:FreeTextBox ID="txtInstruction" runat="server" Width="100%"></FTB:FreeTextBox>
       </div>
       </div>
       <div class="row">&nbsp;</div>
       <div class="row">
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center"><asp:Button ID="btnClose" Text="Close" CssClass="btn btn-large btn-warning" runat="server" onclick="btnClose_Click"/>
