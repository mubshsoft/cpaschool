<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignmentAddOption.aspx.cs" Inherits="Admin_AssignmentAddOption" %>
...
<title>Assignment Qusetion Option</title>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td width="50%" align="left" style="padding-left: 10px">
                                                            ...
                                                            <asp:Label ID="lblCaption" runat="server" Text="Add Option" />
                                                            </strong>
                                                        </td>
                                        ...
                                        <tr align="left" valign="top">
                                            ...
                                            <td height="100%" class="style5" align="center" style="padding-top: 0px; padding-bottom: 20px;">
                                               <table width="600px">
                                                    ...
                                                    <tr>
                                                        <td  colspan="2"  align="centre" class="style5">
                                                   ...
                                                   <%-- <tr>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr align="center">
                                                        ...
                                                        <td  align="left" valign="top" class="style5">
                                                            <asp:DropDownList ID="ddlOptionType" runat="server" Height="18px" TabIndex="2" CssClass="DropDownStyle11" 
                                                                Width="125px">
                                                     ...
                                                     <tr align="center">
                                                        ...
                                                        <td  align="left" valign="top" class="style5">
                                                            <asp:TextBox ID="txtoption" runat="server" TabIndex="3" Width="119" Height="17px" CssClass="style11"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="250px" align="left" valign="middle" style="padding-left:2px">
                                                         
                                                            <asp:ImageButton ID="btnBack" runat="server" 
                                                                ImageUrl="~/Images/back_button.jpg" onclick="btnBack_Click" />   &nbsp;&nbsp;&nbsp;<asp:ImageButton ID="btnSave" runat="server"  
                                                                ImageUrl="~/Images/save.png" onclick="btnSave_Click" ValidationGroup="1"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
