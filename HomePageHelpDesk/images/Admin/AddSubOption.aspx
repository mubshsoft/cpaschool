<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddSubOption.aspx.cs" Inherits="Admin_AddQuestion" %>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td  align="left" valign="top"  class="style5">
                                                            <asp:TextBox ID="txtoption" runat="server" TabIndex="3" Width="120"></asp:TextBox><asp:LinkButton ID="lnkbtnans" runat="server" onclick="lnkbtnans_Click" CausesValidation="false">Click here to add answer as option</asp:LinkButton>
