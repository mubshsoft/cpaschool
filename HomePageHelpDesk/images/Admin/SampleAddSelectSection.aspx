<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="SampleAddSelectSection.aspx.cs" Inherits="Admin_SampleAddSelectSection" Title="Section Info" %>
...
<asp:TextBox ID="txtNoofSection" runat="server" ToolTip="No. of Section" placeholder="No. of Section" CssClass="input-block-level"></asp:TextBox>
                </div></div>
...
<asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-large btn-success" onclick="btnSave_Click"/>
                                ...
                                <div class="user-info media box" style="background-color:#fff;">                         
                               <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                              <asp:GridView ID="gvCategoryList" CssClass="table" runat="server"  AutoGenerateColumns="false" DataKeyNames="CategoryID" 
