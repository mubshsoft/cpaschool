<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="SelectSection.aspx.cs" Inherits="Admin_SelectSection" Title="Section Info" %>
   ...
   <div class="user-info media box" style="background-color:#fff;">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow:auto">
                                              ...
                                              <asp:GridView ID="gvCategoryList" runat="server"  AutoGenerateColumns="false" DataKeyNames="CategoryID" 
                                                    ...
                                                    Width="100%" onrowcommand="gvCategoryList_RowCommand" CssClass="table"
