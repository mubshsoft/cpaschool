<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SampleAddSubOption.aspx.cs" Inherits="Admin_SampleAddSubOption" %>
...
<body>
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div onkeypress="javascript:HideMessage()" align="left">
                                                   ...
                                                   <%-- <tr>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr style="height:30px">
                                                        <td width="250px"  class="style5" align="right" style="padding-right:10px">
                                                            &nbsp;
                                                            <asp:Label ID="lblCountry" runat="server" Text="Option Type :"></asp:Label>
                                                        </td>
                                                        <td width="400px" align="left" valign="middle"  class="style5">
                                                            <asp:DropDownList ID="ddlOptionType" runat="server" Height="25px" TabIndex="2" 
                                                                Width="125px" CssClass="DropDownStyle11">
                                                            <asp:ListItem>Radio Button</asp:ListItem>
                                                            </asp:DropDownList>
                                                         </td>
                                                    </tr>
                                                     <tr>
                                                        <td width="250px" valign="top" style="padding-top:2px; padding-right:10px"  class="style5" align="right">
                                                            <asp:Label ID="lblOption" runat="server" Text="Add Option :"></asp:Label>
                                                            <font color="red">*</font></td>
                                                        <td width="400px" align="left" valign="top"  class="style5">
                                                            <asp:TextBox ID="txtoption" runat="server" TabIndex="3" Width="120"></asp:TextBox><asp:LinkButton ID="lnkbtnans" runat="server" onclick="lnkbtnans_Click" CausesValidation="false">Click 
                                                            here add answer as option</asp:LinkButton>
