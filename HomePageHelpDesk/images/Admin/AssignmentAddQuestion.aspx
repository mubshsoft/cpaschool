<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AssignmentAddQuestion.aspx.cs" Inherits="Admin_AssignmentAddQuestion" Title="Add Question" %>
...
<section class="fullwidth banner-color">
  ...
  <div>
    ...
    <asp:DropDownList ID="ddlQuestionType" runat="server" AutoPostBack="true" CssClass="input-block-level" TabIndex="1" onselectedindexchanged="ddlQuestionType_SelectedIndexChanged">
    ...
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtQuestion" runat="server" TextMode="MultiLine" TabIndex="3" Rows="4" ToolTip="Question" placeholder="Question" CssClass="input-block-level"></asp:TextBox>
