<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AddAssignmentSet.aspx.cs" Inherits="Admin_AddAssignmentSet" Title="Assignment Set"%>
...
<section class="fullwidth banner-color">
    ...
    <asp:TextBox ID="txtAssignmentcode" ToolTip="Assignment Code" PlaceHolder="Assignment Code" runat="server" CssClass="input-block-level"></asp:TextBox>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                                        
     <asp:DropDownList ID="ddlAssignmentType" runat="server" ToolTip="Assignment Type" CssClass="input-block-level" AutoPostBack="True" OnSelectedIndexChanged="ddlAssignmentType_SelectedIndexChanged">
