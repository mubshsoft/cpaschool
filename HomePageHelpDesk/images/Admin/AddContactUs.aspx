<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AddContactUs.aspx.cs" Inherits="AddContactUs" ValidateRequest="false" Title="Contact Us"  %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
       ...
       <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><FTB:FreeTextBox ID="txtInstruction" runat="server" Width="100%"></FTB:FreeTextBox></div></div>
       <div class="row">&nbsp;</div>
