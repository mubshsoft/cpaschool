<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster-new.master" AutoEventWireup="true" CodeFile="AddInduction.aspx.cs" Inherits="Admin_AddInduction" %>
...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
     <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:Label ID="lblMessage" EnableViewState="false" runat="server" Text="" ForeColor="Red"></asp:Label></div></div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" >
           <asp:DropDownList ID="ddlCourse" runat="server" ToolTip="Course Code" CssClass="input-block-level"  />
      </div>
      </div>
      <div class="row" >
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 form_text field-label">Type :</div>
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" >
           <asp:DropDownList ID="ddlSubject" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSubject_SelectedIndexChanged" CssClass="input-block-level">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtCaption" runat="server" CssClass="input-block-level" TabIndex="3"></asp:TextBox></div>
      </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtURL" runat="server" CssClass="input-block-level" TabIndex="3"></asp:TextBox></div>
      </div>
       <div class="row" >
    ...
    <div class="modal hide fade in" id="ModalPopupDivPlayVideo" aria-hidden="false" style="align-content:flex-start">
    ...
    <!--Modal Body-->
    <div class="modal-body" style="width:620px;height:auto">
         <%-- <div class="scroller" data-height="900px">--%>
         <video width = "600px" height = "420" controls id = "Video">
