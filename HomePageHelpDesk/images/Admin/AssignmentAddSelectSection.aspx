<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AssignmentAddSelectSection.aspx.cs" Inherits="Admin_AssignmentAddSelectSection" Title="Section Info" %>
...
<section class="fullwidth banner-color">
    ...
    <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <asp:TextBox ID="txtNoofSection" ToolTip="Number of Section" PlaceHolder="Number of Section" runat="server" CssClass="input-block-level"></asp:TextBox>
    </div>
    </div>
...
<div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:HiddenField ID="hdnAsgnId" runat="server" />
                                            </div>
                                            </div>
       </div>                     
