<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="VB" AutoEventWireup="false" CodeFile="AddFeeAndSemesterDuration.aspx.vb" Inherits="Admin_AddFeeAndSemesterDuration" Title="Add Fee And Semester Duration" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                      <ContentTemplate>
                       ...
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:Label ID="lblMessage" EnableViewState="false" runat="server" Text="" ForeColor="Red"></asp:Label>
                         ...
                         <div class="row">
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                         <asp:DropDownList ID="ddlnationality" runat="server" ToolTip="Nationality" CssClass="input-block-level" AutoPostBack="True">
                        ...
                        <div class="row">
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlapplicantCategory" runat="server" ToolTip="Category" CssClass="input-block-level" AutoPostBack="True"/>
                        ...
                        <div class="row">
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <asp:DropDownList ID="ddlFeetype" runat="server" ToolTip="Fee Type" AutoPostBack="true" CssClass="input-block-level">
                       ...
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                              ...
                                                              <tr id="Row1" runat="server" visible="false" >
                                                                ...
                                                                <td>&nbsp;</td>
                                                                <td align="left">
                                                                     <asp:TextBox ID="txtFee" runat="server" Visible="false" CssClass="input-block-level" ></asp:TextBox>
                                                                     &nbsp;
