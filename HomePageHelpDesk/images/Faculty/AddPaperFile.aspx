<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="AddPaperFile.aspx.cs" Inherits="AddPaperFile" Title="Upload lectures" %>
  ...
  <section class="fullwidth banner-color">
    ...
    <div class="user-info media box" style="background-color:#fff;">
       <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlSem" AutoPostBack="true" ToolTip="Semester" runat="server" CssClass="input-block-level" onselectedindexchanged="ddlSem_SelectedIndexChanged" />
                                   <asp:Label ID="lblreqsem" runat="server" Text="" ForeColor="Red"></asp:Label></div>
                </div>
                <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlModule" ToolTip="Module" AutoPostBack="true"  runat="server" CssClass="input-block-level" onselectedindexchanged="ddlModule_SelectedIndexChanged" />
                <asp:Label ID="lblreqmodule" runat="server" Text="" ForeColor="Red"></asp:Label></div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlPaper" ToolTip="Paper" runat="server" CssClass="input-block-level" />
                                   <asp:Label ID="lblreqpaper" runat="server" Text="" ForeColor="Red"></asp:Label></div> 
                </div>
                <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:TextBox ID="txtfilecaption" runat="server" ToolTip="File Caption" placeholder="File Caption" CssClass="input-block-level" ></asp:TextBox>
                                    <asp:Label ID="lblpapercaption" runat="server" ForeColor="Red" Text=""></asp:Label></div>
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><asp:FileUpload ID="FileUpload1" runat="server" />
                                   <asp:Label ID="lblfileupload" runat="server" Text="" ForeColor="Red"></asp:Label></div>
</div>
