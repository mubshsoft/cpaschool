<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster-new.master" AutoEventWireup="true" CodeFile="FacultyListAssignment.aspx.cs" Inherits="Faculty_FacultyListAssignment" %>
...
<div class="row">
     ...
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                        
      <asp:DropDownList ID="ddlListAssignmentSet" runat="server" AutoPostBack="true" ToolTip="Assignment Code" Width="100%" CssClass="input-block-level" >
         ...
         <div class="row">
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <span> Assignment Assigned to <%=Session["username"].ToString() %></span>
                 </div>
         </div>
                  <div class="row">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center" style="overflow:auto; height:600px">
                 
                 <asp:GridView ID="GrdAssignment" AutoGenerateColumns="false" runat="server" DataKeyNames="AsgnId"
                                                    ...
                                                    <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Assignment Type" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="15%">
                                                                       ...
                                                                       <asp:TemplateField HeaderText="Assignment Code" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="15%" >
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblasgncode" Text='<%# Eval("asgncode") %>' runat="server" ></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="PaperTitle" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="20%"  >
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="hdnAsgnid" runat="server" Value='<%#Eval("AsgnId") %>' />
                                                             ...
                                                             <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Left">
                                                                ...
                                                                <asp:TemplateField ItemStyle-HorizontalAlign="Left"  HeaderText="Answer Sheet">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:LinkButton ID="lnkSubmitMarkformanual" OnClientClick=<%# "openPopuppage(" + Eval("AsgnID") + ",'" + Eval("Userid") + "')" %> runat="server" Visible="false" >Submit Marks </asp:LinkButton>
