<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LoginReport.aspx.vb" Inherits="Admin_LoginReport" %>
                            ...
                            <td align="center" valign="top">
                                <div class="frame" >
                                    <table width="700" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr align="left" valign="top">
                                        <td width="3">&nbsp;</td>
                                             <td colspan="3" class="style5" align="center"><strong>Student Login Details</strong></td>
                                          <td width="3">&nbsp;</td>
                                        </tr>
                                        <tr>
                                        <td colspan="3">
                                        ...
                                        <tr align="left" valign="top">
                                            ...
                                            <td height="100%" class="style5" align="center" style="padding-top: 20px; padding-bottom: 20px;">
                                                 <asp:GridView ID="GrdLoginReport" AutoGenerateColumns="false" runat="server" DataKeyNames="StuLogId"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="QueryId" ItemStyle-HorizontalAlign="Left" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblStuLogId" Text='<%# Eval("StuLogId") %>' runat="server" CssClass="left_padding"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Student Name" ItemStyle-HorizontalAlign="Left" >
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblStName" Text='<%# Eval("Name") %>' runat="server" CssClass="left_padding"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                      ...
                                                      <asp:TemplateField HeaderText="Login From" ItemStyle-HorizontalAlign="Left" >
                                                       ...
                                                       <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("StuLogId") %>'>Delete</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
