<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="StudentActiveExamReport.aspx.cs" Inherits="StudentActiveExamReport" Title="Assign Student for Exam" %>
...
<asp:DropDownList ID="ddlExam" AutoPostBack="true"  runat="server" ToolTip="Exam Code"  CssClass="input-block-level" onselectedindexchanged="ddlExam_SelectedIndexChanged" />
<asp:Label ID="lblreqcourse" runat="server" ForeColor="Red" Text=""></asp:Label>
    ...
    <asp:DropDownList ID="ddlbatch" AutoPostBack="true" runat="server" ToolTip="Batch"  CssClass="input-block-level" />
     ...
     <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">              
    <asp:DropDownList ID="ddlstatus" AutoPostBack="true"  runat="server" ToolTip="Status"  CssClass="input-block-level">
