...
<iframe name="popFrame" src="../UNTITLED.htm" frameborder="0" scrolling="no" width="152" height="147"></iframe>
    ...
    <asp:DropDownList ID="ddlCourse" runat="server" CssClass="input-block-level" ToolTip="Course" AutoPostBack="True" onselectedindexchanged="ddlcourse_SelectedIndexChanged">
                                                                     </asp:DropDownList>
    </div> 
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlbatch" runat="server" CssClass="input-block-level" ToolTip="Batch" AutoPostBack="True">
                                                                     </asp:DropDownList>
    </div>
    </div>  
     <div class="row" >
