...
input[type=checkbox], input[type=radio] {
    ...
    <div class="user-info media box" style="background-color:#fff;">
                 ...
                 <div class="row" style="margin-top: 20px;">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" ><asp:TextBox ID="txtEmailAddress" runat="server" CssClass="input-block-level" MaxLength="49" Enabled="false"></asp:TextBox></div>
                 </div>
     </div>
     <div class="user-info media box" style="background-color:#fff;">
                <div class="row">
                ...
                <div class="row" style="margin-top: 20px;">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtFirstName" runat="server" CssClass="input-block-level" MaxLength="50" Enabled="false"></asp:TextBox></div>
                                                        
                 </div>
                 <div class="row">            
                             <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 form_text field-label">Middle Name :</div>
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtMiddleName" runat="server" CssClass="input-block-level" MaxLength="50" Enabled="false"></asp:TextBox></div>
                 </div>
                 <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtLastName" runat="server" CssClass="input-block-level" MaxLength="50" Enabled="false"></asp:TextBox></div>
                </div>
                <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtDOB" runat="server" CssClass="input-block-level" MaxLength="10" Enabled="false"></asp:TextBox></div>
                </div>
               ...
               <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtPermanentAddress" runat="server" CssClass="input-block-level" TextMode="MultiLine" Rows="4" Enabled="false"></asp:TextBox></div>
                </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 form_text field-label">Correspondence Address :</div>
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtCorrespondenceAddress" runat="server" CssClass="input-block-level" TextMode="MultiLine" Rows="4" Enabled="false"></asp:TextBox></div>
                </div>
                <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtContactNumber" runat="server" CssClass="input-block-level" MaxLength="15" Enabled="false"></asp:TextBox></div>
                </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 form_text field-label">Mobile Number :</div>
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtMobileNumber" runat="server" CssClass="input-block-level" MaxLength="15" Enabled="false"></asp:TextBox></div>
                </div>
      </div> 
      <div class="user-info media box" style="background-color:#fff;">
      <div class="row">
                ...
                <div class="row" style="margin-top: 20px;">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtGender" runat="server" CssClass="input-block-level" MaxLength="15" Enabled="false"></asp:TextBox></div>
                </div>
                <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtNationality" runat="server" CssClass="input-block-level" MaxLength="15" Enabled="false"></asp:TextBox></div>
                </div>
                 <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtCategory" runat="server" CssClass="input-block-level" MaxLength="15" Enabled="false"></asp:TextBox></div>
                </div>
                <div class="row">
                             <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 form_text field-label">Profile :</div>
                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><asp:TextBox ID="txtprofile" CssClass="input-block-level" MaxLength="1000" runat="server" Rows="4" TextMode="MultiLine" Enabled="false"></asp:TextBox></div>
                </div>
     </div>                                           
     </div>
     </div>  
