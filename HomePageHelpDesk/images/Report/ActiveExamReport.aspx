<%@ Page MasterPageFile="~/HomeMaster-new.master" Language="C#" AutoEventWireup="true" CodeFile="ActiveExamReport.aspx.cs" Inherits="ActiveExamReport" Title="Assign Exam Report" %>
...
<iframe name="popFrame" src="../UNTITLED.htm" frameborder="0" scrolling="no" width="152" height="147"></iframe>
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <asp:DropDownList ID="ddlCourse" AutoPostBack="true"  runat="server" ToolTip="Course"  CssClass="input-block-level" onselectedindexchanged="ddlCourse_SelectedIndexChanged" /><asp:Label ID="lblreqcourse" runat="server" Text="" ForeColor="Red"></asp:Label>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlbatch" AutoPostBack="true"  runat="server" ToolTip="Batch"  CssClass="input-block-level" />
    </div>
    </div>
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:TextBox ID="txttodt" runat="server" CssClass="input-block-level" ToolTip="To actvate Date" placeholder="To actvate Date"></asp:TextBox><%--<input id="Image1" runat="server" onclick="popFrame.fPopCalendar(txttodt,txttodt,popCal);return false" type="image"  src="~/Images/calender.png" style="vertical-align: bottom; width: 22px; height: 22px" />--%>
