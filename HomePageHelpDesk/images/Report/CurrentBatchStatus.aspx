...
input[type=checkbox], input[type=radio] {
   ...
   <div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlbatch" runat="server" AutoPostBack="True" ToolTip="Batch Title"  CssClass="input-block-level" meta:resourcekey="ddlbatchResource1" onselectedindexchanged="ddlbatch_SelectedIndexChanged">
                                                            </asp:DropDownList>
    </div>
    </div>
    <div class="row" >
