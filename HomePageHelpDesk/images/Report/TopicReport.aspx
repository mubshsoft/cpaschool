...
input[type=checkbox], input[type=radio] {
    ...
    <h1 class="heading-color">Discussion Topic Reports<asp:Label ID="lblCaption" runat="server" /></h1> 
...
<asp:DropDownList ID="ddlCourse" runat="server" ToolTip="Course Title"  CssClass="input-block-level" AutoPostBack="True" onselectedindexchanged="ddlCourse_SelectedIndexChanged">
                                                            </asp:DropDownList>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
<asp:DropDownList ID="ddlbatch" runat="server" ToolTip="Batch Code" CssClass="input-block-level" AutoPostBack="True" onselectedindexchanged="ddlbatch_SelectedIndexChanged" meta:resourcekey="ddlbatchResource1">
                                                              </asp:DropDownList>
    </div>
    </div>
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
<asp:DropDownList ID="ddlSemester" runat="server" ToolTip="Semester" CssClass="input-block-level" AutoPostBack="True" onselectedindexchanged="ddlSemester_SelectedIndexChanged">
                                                           </asp:DropDownList>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
<asp:DropDownList ID="ddlTopic1" runat="server" ToolTip="Topic" CssClass="input-block-level" AutoPostBack="True" onselectedindexchanged="ddlTopic1_SelectedIndexChanged1">
                                                           </asp:DropDownList>
    </div>
    </div>                             
