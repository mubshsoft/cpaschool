...
<asp:DropDownList ID="ddlCourse" runat="server" ToolTip="Course"  CssClass="input-block-level" AutoPostBack="True" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged">
                                                                </asp:DropDownList>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
<asp:DropDownList ID="ddlbatch" runat="server" ToolTip="Batch"  CssClass="input-block-level" AutoPostBack="True" meta:resourcekey="ddlbatchResource1" onselectedindexchanged="ddlbatch_SelectedIndexChanged">
                                                                </asp:DropDownList>
    </div>
    </div>
    ...
    <div class="user-info media box" style="background-color:#fff;">
    <div class="row" >                                                  
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><asp:TextBox ID="TextBox1" runat="server" CssClass="input-block-level" placeholder="Search Through" ToolTip="Search Through"></asp:TextBox></div>                                                 
