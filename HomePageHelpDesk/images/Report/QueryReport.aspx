...
input[type=checkbox], input[type=radio] {
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
     <asp:DropDownList ID="ddlCourse" runat="server" ToolTip="Course" CssClass="input-block-level" AutoPostBack="True" onselectedindexchanged="ddlcourse_SelectedIndexChanged"></asp:DropDownList>
    </div> 
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlbatch" runat="server" ToolTip="Batch" CssClass="input-block-level" AutoPostBack="True"></asp:DropDownList>
    </div> 
    </div>
    <div class="row" >
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlTo" runat="server" ToolTip="Query To" CssClass="input-block-level" AutoPostBack="True">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlStauts" runat="server" ToolTip="Status" CssClass="input-block-level" AutoPostBack="True">
                                                                        <asp:ListItem Value="-1">ALL</asp:ListItem>
