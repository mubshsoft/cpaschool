...
input[type=checkbox], input[type=radio] {
    ...
    <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><asp:DropDownList ID="ddlbatch" runat="server" AutoPostBack="True" ToolTip="Batch" CssClass="input-block-level" onselectedindexchanged="ddlbatch_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                            </div></div>
    <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlGender" runat="server" AutoPostBack="True"  ToolTip="Gender" CssClass="input-block-level">
    ...
    <div class="row" >
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <asp:DropDownList ID="ddlCategory" runat="server" AutoPostBack="True" ToolTip="Category" CssClass="input-block-level">
                                                                   <asp:ListItem>All</asp:ListItem>
