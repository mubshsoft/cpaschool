    ...
    Protected Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
        Try
            ...
            If Session("role") = "Faculty" Then
                strLogin = "update FacultyLoginHistory set loginout='" & System.DateTime.Now & "' where fid=" & Session("fid") & " and loginfrom='" & Session("IPADD") & "' and logindate='" & Session("datetim") & "'"
            ElseIf Session("role") = "Student" Then
                strLogin = "update studentLoginHistory set loginout='" & System.DateTime.Now & "' where stid=" & Session("stid") & " and loginfrom='" & Session("IPADD") & "' and logindate='" & Session("datetim") & "'"
            End If
