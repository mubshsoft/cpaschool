<%@ Control Language="VB" AutoEventWireup="false" CodeFile="MainHeader_inner.ascx.vb" Inherits="MainHeader_inner" %>
 <style type="text/css">
        .menuItem
        {
...
<table>
   <tr>
                           ...
                           <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="../../download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0"
                                    width="703" height="70">
                                    <param name="movie" value="images/menu_top_inner.swf">
                                    <param name="quality" value="high">
                                    <param name="menu" value="false">
                                    <!--[if !IE]> <-->
                                    <object data="images/menu_top_inner.swf" width="703" height="70" type="application/x-shockwave-flash">
                                        <param name="quality" value="high">
                                        <param name="menu" value="false">
