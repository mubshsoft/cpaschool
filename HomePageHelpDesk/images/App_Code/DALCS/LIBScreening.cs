...
namespace fmsf.lib
{
    ...
    public class LIBScreening
    {
        ...
        public string ScreeningDisplayText
        {
            get { return "ScreeningName"; }


        }

        public string ScreeningValueField
        {
    ...
    [Serializable]
    public class LIBScreeningListing : List<LIBScreening>
    {
