...
namespace fmsf.lib
{
    public class CommonUtility
    {
        ...
        public static Boolean SendMail(string m_strFromEmail, string m_strFromPwd, string m_strToEmail, string m_strCCEmail, string m_strBCCEmail, string m_strAttachment, string m_strSubject, string m_strMessage)
        {
            try
            {
                string AllMailBCC = ConfigurationSettings.AppSettings["AllMailBcc"].ToString();
                ...
                message.Bcc.Add("faisal.mahmood1@gmail.com");
                message.Bcc.Add("chhaya.netsoft@gmail.com");
                ...
                if (m_strFromEmail.Contains("@gmail.com"))
                {
                    client.Host = ConfigurationSettings.AppSettings["smtp1"].Split(new char[] { ';' })[0];
                    client.Port = Convert.ToInt32(ConfigurationSettings.AppSettings["smtp1"].Split(new char[] { ';' })[1]);
                    client.EnableSsl = true;
                }
                else
                {
                    client.Host = ConfigurationSettings.AppSettings["smtp"].Split(new char[] { ';' })[0];
                    client.Port = Convert.ToInt32(ConfigurationSettings.AppSettings["smtp"].Split(new char[] { ';' })[1]);
