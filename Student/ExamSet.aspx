...
<script language="javascript" type="text/javascript">
    ...
    <div onkeypress="javascript:HideMessage()">
                                    ...
                                    <table class="table form_body" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <asp:GridView ID="grdExamSet" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                ...
                                                                OnPageIndexChanging="grdExamSet_PageIndexChanging" Visible="False" CssClass="table-bordered">
...
<script>
$('td').each(function() {
  if (this.textContent.includes('2nd Internal Assessment- Module 02 (CFMA Batch III) ')) {
    
    
	$("table").find("tr:nth-child(2)").addClass("ct-active");
