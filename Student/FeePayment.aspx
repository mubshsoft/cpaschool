...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="content-wrapper">
    ...
    <div onkeypress="javascript:HideMessage()">
        ...
        <div class="row">&nbsp;</div>                                                     
        <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center"><asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btn btn-warning"/> 
        <asp:Button ID="btnPay" runat="server"  Text="Pay Now" CssClass="btn btn-success btn-large arial"/></div></div>
        <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i>Note: Insclusive of 18% GST</i></div></div>
