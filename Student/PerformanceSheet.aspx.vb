...
Partial Class student_PerformanceSheet
    ...
    Sub bindStudentPerformanceSheet()
        Try
            ...
            If dsSheet IsNot Nothing Then
                ...
                End If
            End If
            frmprogress.Attributes.Add("src", "chartnew1.aspx?cid=" & Request.QueryString("cid") & "&stid=" & Request.QueryString("stid") & "&bt=" & Request.QueryString("bt"))
            ...
            For i As Integer = 0 To dlstPerformanceSheet.Items.Count - 1
                ...
                Try
                    ...
                    Try
                        ...
                        Dim strq As String = "select ExamMarks,AssignmentMarks,DiscussionForumMarks from evaluationcriteria where courseid=" & Request.QueryString("cid").ToString & ""
                        Dim dsSheet As New DataSet()
                        dsSheet = CLS.fnQuerySelectDs(strq)
                        If dsSheet IsNot Nothing Then
                            If dsSheet.Tables IsNot Nothing Then
    ...
    Protected Sub btnback_Click(sender As Object, e As System.EventArgs) Handles btnback.Click
        Response.Redirect("StudentPerformaneCourse.aspx?bid=" + Request.QueryString("bt"))
    End Sub
