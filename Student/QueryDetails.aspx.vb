Imports fmsf.DAL
Imports fmsf.lib
Partial Class Student_QueryDetails
    ...
    Sub BindGrid()
        ...
        Try
            ...
            Dim strq As String
            If iFid = 0 Or iFid = -1 Then
                strq = "select fid as facid,QueryId,stid,Subject,Query,Status,QueryDate,ReplyDate,Reply from QuerySubmission where QueryId=" & queryval & ""
            Else
                strq = "select q.fid as facid,q.QueryId,q.stid,f.firstName,q.Subject,q.Query,q.Status,q.QueryDate,q.ReplyDate,q.Reply from QuerySubmission q INNER JOIN FacultyRegistration f on q.Fid=f.Fid where q.QueryId=" & queryval & ""
            End If
                ...
                If dsQuery.Tables IsNot Nothing Then
                    If dsQuery.Tables(0).Rows IsNot Nothing Then
                        If dsQuery.Tables(0).Rows.Count > 0 Then
                            ...
                            If iFid = 0 Or iFid = -1 Then
                                If dsQuery.Tables(0).Rows(0)("facid").ToString() = "0" Then
                                    lblQueryFor.Text = "Admin"
                                Else
                                    lblQueryFor.Text = "Course Coordinator"
                                End If
