...
<div class="content-wrapper">
    ...
    <section class="content-header">
         <h1> <i class="fa fa-area-chart"></i>Progress Report</h1>
          <ol class="breadcrumb">
            <li><a href="../Student/StudentDashboard.aspx"><i class="fa fa-user"></i> Student Panel</a></li>
              <li><a href="../Student/StudentProgressCourse.aspx"> List of Course</a></li>
...
<script type="text/javascript">
    ...
    var pdata = []
        ...
        var b = document.getElementsByClassName("canvasjs-chart-credit")
