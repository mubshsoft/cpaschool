<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Student/StudentMaster.master" CodeFile="SubmitExam.aspx.cs" Inherits="SubmitExam" Title="Submit Exam" %>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                       <div class="row">
                                                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 well" style="background:#fff; ">
                                                                <asp:DataList ID="dlsquestion" Width="100%" runat="server" OnItemDataBound="dlsquestion_ItemDataBound" Height="230px">
                                                                    <ItemTemplate>
                                                                                 <div class="row">
                                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border-bottom: solid 1px #f3f1f1; margin-bottom :10px;">
                                                                                    <div class="col-lg-8">
                                                                                      ...
                                                                                      <div class="col-lg-4" style="font-family: sans-serif;font-size: 14px;font-weight: 100;font-variant: small-caps;">
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td  valign="middle" width="70%" style="padding-top:7px; text-align:right">
                                                                                                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                            ...
                                                            <!-- Ques. Numbers start-->
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 well" style="height:350px; overflow:auto; background:#fff; ">
