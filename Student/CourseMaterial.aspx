<%@ Page Title="" Language="C#" MasterPageFile="~/Student/StudentMaster.master" AutoEventWireup="true" CodeFile="CourseMaterial.aspx.cs" Inherits="Student_CourseMaterial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function (responce) {
                        ...
                        var url =data.rows[0].FilePath;
                         ...
                         var vid="";
                         vid = vid + "<video width='570' height='340' controls id='IframeVideo'><source src='" + url + "' id='ifrm4addnote' type='video/mp4'></source></video>";
        ...
        function ViewAssessmentSchapter(unitid) {
            ...
            var uid = unitid.toString();
            var url = "ViewAssessmentsChapter.aspx?id=" + uid;

            $('#ifrmssessment').attr('src', url);
            $('#ModelPopupDivAssessment').modal('show');
        }

        function ViewAssessmentSchapter_old(unitid) {
  ...
  <div class="content-wrapper">
   ...
   <li><a href="../Student/StudentListCourse.aspx"><i class="fa fa-user"></i> List of Course</a></li>
 ...
 <%--<div class="content-container-fluid">
        ...
        <div class="modal fade in" id="ModalPopupDivPlayVideo" >
    ...
    <div class="modal-body" style="height:auto">
      ...
      <iframe id="ifrm" style="width:900px;height:850px;" ></iframe>
...
<div class="modal fade in" id="ModalPopupDivPlayVideoWithAddnote" >
              ...
              <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" >
                  ...
                  <div class="row" >
                      <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                          <input type="text" id="txtnote" name="txtnote" value="" class="form-control" /></div>
                          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                          <input type="button" id="addnote" name="addnote" value="Save" class="btn btn-primary" />
                      </div>
                  </div>
...
<div class="modal fade in" id="ModalPopupDivnote" >
...
<div class="modal fade in" id="ModelPopupDivAssessment" >
    <div class="modal-dialog" style="width: 80%;">
    <div class="modal-content">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span></button>
        <h4><span class="align:center"> View Assessment</span></h4>
    </div>
    <!--Modal Body-->
    <div class="modal-body" style="height:auto" width="100%">
        ...
        <div>
          ...
          <div class="row">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         <iframe id="ifrmssessment" style="width:100%; height:850px;" ></iframe>
                      </div>
                  </div> 
        ...
        function OnSuccess4Notes(response) {
            ...
            for (var i = 0; i < CountRecord; i++) {
                ...
                if (!arrRevised.contains(customer.Caption)) {
                    ...
                    table = table + '<tr><td width="80%" style="line-height:22px;" >' + customer.Note + '</td>' + '<td width="20%" align="left" style="line-height:22px;"><i class="icon-calendar"></i>&nbsp;' + customer.Caption + '</td></tr>';
                   ...
                   // $("#spnNotes").append("</br>" + customer.Note);
                    ...
                    table = table + '<tr><td width="80%" style="line-height:22px;">' + customer.Note + '</td><td width="20%" style="line-height:22px;">&nbsp;</td></tr>';
