...
.sampleset-box {background:url(../images/sampleset-bg.png); border-radius:10px; padding:2em 1em; background-size: cover; background-position: 50%;}
.start {background:#fff; padding:5px 10px; border-radius:15px;}
    </style>
   ...
   <div class="row">
        ...
        <div class="sampleset-box"><h4>Test</h4>
        <a href="#" class="start"> <i class="fa fa-play-circle"></i> <b>Start</b></a></div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
        <div class="sampleset-box"><h4>Test</h4>
        <a href="#" class="start"> <i class="fa fa-play-circle"></i> <b>Start</b></a></div>
