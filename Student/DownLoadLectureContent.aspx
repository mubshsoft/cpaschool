...
<li><a href="../Student/StudentLectureListCourse.aspx"><i class="fa fa-user"></i> View Lecture</a></li>
                                               ...
                                               <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                ...
                                                <div class="box box-primary"><div class="box-header">
                                                        ...
                                                        <div class="box-body">
                                                                 ...
                                                                 PagerSettings-LastPageText="Last" PagerSettings-Mode="NumericFirstLast"  OnRowDataBound="grdExamSet_RowDataBound"
                                                    PagerStyle-HorizontalAlign="Center" PageSize="10"  OnPageIndexChanging="grdExamSet_PageIndexChanging"
