<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Student/StudentMaster.master" CodeFile="EndExam.aspx.cs" Inherits="EndExam" Title="End Exam" %>
      ...
      <div class="content-wrapper" onkeypress="javascript:HideMessage(),HideMessage2(),HideMessage3()">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Examination Completed</li>
          </ol>
        </section>
