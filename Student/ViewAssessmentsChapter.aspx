...
.progressbar {
    ...
    $('#chapterlist li').on('click', function () {
        ...
        CallReadingChapter(unitId, chapterId);
    });
});

function CallReadingChapter(unitId, chapterId) {
    $.ajax({
        type: "POST",
        url: "Student_ViewAssessmentsChapter.aspx/CallReadingChapter",
        data: JSON.stringify({ UnitId: unitId, ChapterID: chapterId }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            console.log("Chapter view recorded successfully: " + response.d);
        },
        error: function (response) {
            console.log("Error recording chapter view: " + response.responseText);
        }
    });
}
