<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Student/StudentMaster.master" CodeFile="StudentProgressCourse.aspx.vb" Inherits="Student_StudentProgressCourse" Title="List of course" %>
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Course Title" ItemStyle-HorizontalAlign="Center" >
                                                           ...
                                                           <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <a id="a1" href="chart.aspx?cid=<%#Container.DataItem("courseID")%>&stid=<%#Container.DataItem("stid")%>&bt=<%#Container.DataItem("bid")%>">
                                                                   View </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
