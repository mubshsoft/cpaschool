<%@ Control Language="VB" AutoEventWireup="false" CodeFile="StudentHeader.ascx.vb" Inherits="StudentHeader" %>
 <style type="text/css">
        .menuItem
        {
...
<asp:HiddenField ID="hdnLoginFrom" runat="server" />
<asp:HiddenField ID="hdnRole" runat="server" />
<asp:HiddenField ID="hdnLoginDate" runat="server" />
