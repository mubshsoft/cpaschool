...
<section id="slider" class="fullwidth">
      <div class="slider owl-carousel owl-theme">
            ...
            <ItemTemplate>
                ...
                <a href="CourseDetailsInfo.aspx?cid=<%# Eval("Courseid")%>" target="_blank">
                    <div class="item">
                    <img src="Images/slider/<%# Eval("images")%>" alt="" class="img-responsive" />
                    <div class="cover">
                    <div class="container">
                        <div class="row">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-sm-6 col-xs-12">
        <div class="title">
          <h2 style="text-align: left;">Welcome to CPA School of Learning!</h2>
        </div>
        <div class="para" style="text-align: justify;">
             <asp:Label ID="lbltext" runat="server" CssClass="no-margin" Text="" Visible="false"></asp:Label>
          <p>CPA Learning Systems is an interactive online learning platform for individuals working in the not-for-profit sector as well as those interested to join the sector. This online platform aims to break the barriers of distance & provide knowledge to all those who do not have access to structured training programs in the areas of financial management; legal compliances; governance; planning, monitoring & evaluation and FCRA.</p>
          <p>Since 2008, CPA School of learning has been a leader in online education for voluntary sector, putting quality hands-on and online curriculum directly to the students and organizations we support. We empower students to learn in the ways that are best for them at their own place. </p>
      ...
      <div class="col-lg-6 col-sm-6 col-xs-12">
        <div class="static-data">
            <div class="col-lg-4 col-sm-4 col-xs-4">
              <div class="static">
                <div class="panel">
                  <div class="panel-body counter-box">
                    <div class="simg"><img src="images/alumni.png" /></div>
                    <div class="cot-text aos-init aos-animate" data-aos="fade-right" data-aos-duration="1200">
                      

                      <div class="counter" data-count="<%=stdAdmissionCount %>"><%=stdAdmissionCount %></div>
                      <div class="ctext">Enrollment So Far</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="panel">
                  <div class="panel-body">
                    ...
                    <div class="aos-init aos-animate" data-aos="fade-right" data-aos-duration="1200">
                                    ...
                                    <span class="counter"><%=stdCourseCount.ToString()%></span>
                                    <div class="ctext">Courses Offered</div>
                                </div>
                            </div>
...
<div class="col-lg-4 col-sm-4 col-xs-4" style="text-align:center"><div class="simg"><a href="KnowledgeCenterDetails.aspx?SubjectType=Magazine and Article"><img src="images/KnowledgeCenter-articles.png" /><br /><b>Articles</b></a></div></div>
 ...
 <div class="title">
        ...
        </div>   <div class="col-lg-3 col-sm-12 col-xs-12">
      ...
      <asp:Repeater ID="DlsDetails" runat="server">
              ...
              <div class="flipbox-inner1">
                  <div class="flipbox-front1">
                                        <div class="hs-img">
                      <%--<img src="images/graduation-cap.png" />--%>
                      <img src="<%# Eval("CourseOfferedIcon")%>" />
                    </div>
                                        <div class="hs-title">
...
<section class="sectionpad newsbg fullwidth">
    ...
    <asp:Repeater ID="dlnews" runat="server">
			...
			<small class="date"><i class="calenders"></i> <%#Format(CDate(DataBinder.Eval(Container.DataItem, "newsdate")), "dd-MMM-yyyy")%></small>
			<span><%#Replace(Replace(Replace(Replace(DataBinder.Eval(Container.DataItem, "newsdesc"), "dq$", """"), "com$", ","), "qu$", "'"), "amp$", "&")%></span>
		</a><hr />
                           <%-- <div class="media-body" style="padding-left: 10px; text-align: justify; font-size:14px;">
                            ...
                            <div id="myModalNews<%#Eval("NewsId")%>" class="modal fade in" tabindex="-1" role="dialog" aria-labeledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" >
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title"><small class="date"><i class="calenders"></i> <%#Format(CDate(DataBinder.Eval(Container.DataItem, "newsdate")), "dd-MMM-yyyy")%></small></h4>
                                            <button type="button" class="close" data-dismiss="modal" id="btnClose" onclick="Close(<%#Eval("NewsId")%>);">&times;</button>
                                        </div>
                                        <div class="modal-body">
                                             <%#Replace(Replace(Replace(Replace(DataBinder.Eval(Container.DataItem, "newsdesc"), "dq$", """"), "com$", ","), "qu$", "'"), "amp$", "&")%><br /><br /><br /><br />
                                        
                                         <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align:right;display:inline-flex">
                                             ...
                                             <a class="btn btn-twitter" href="https://twitter.com/intent/tweet?text=<%#Replace(Replace(Replace(Replace(DataBinder.Eval(Container.DataItem, "newsdesc"), "dq$", """"), "com$", ","), "qu$", "'"), "amp$", "&")%>" data-size="large" title="Twitter Share"><i class="fa fa-twitter"></i></a>
                                             <a class="btn btn-linkedin" onclick="return Linkedins_click()" title="Linkedin Share"><i class="fa fa-linkedin"></i></a>
                                             <a class="btn btn-google" href="https://plus.google.com/share?url=http://http://fmsflearningsystems.org/" title="Google Plus Share"><i class="fa fa-google-plus"></i></a>
                                         </div>
                                        ...
                                        <div class="modal-footer" >
                                            <button type="button" class="btn btn-default" data-dismiss="modal" onclick="Close(<%#Eval("NewsId")%>);">Close</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
          ...
          <a class="readmore" href="DetailsNewsEvents.aspx">View All</a>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="imp-link">
...
<div class="video-img-thum">
    <video width="380" height="365" controls id="IframeVideo" style="background: #fff; padding: 1em;">
 ...
 <%--<div class="video-title"><span>Webinar on FCRA IMPACT</span></div>--%>
          ...
          <a class="readmore" href="KnowledgeCenterDetails.aspx?SubjectType=Video Pods">View All</a>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="imp-link">
    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" onclick="CloseCalendar();">&times;</button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal" onclick="CloseCalendar();">Close</button>
            </div>
        </div>
    </div>
</div>
...
<div id='2'><div class='img'><img src='https://image.ibb.co/kL6AES/Top_SA_Nicky_Oppenheimer.jpg' alt=''></div>
  ...
  window.watsonAssistantChatOptions = {
      integrationID: "c454e3be-89af-46c0-a4f3-d2650d27bf1f", // The ID of this integration.
      region: "eu-gb", // The region your integration is hosted in.
      serviceInstanceID: "f79f9913-134f-4c29-8912-fc9cc993d4e7", // The ID of your service instance.
        ...
        <% If (dsTestimonials.Tables(0).Rows.Count > 0) Then%>
         ...
         <%For i As Integer = 0 To dsTestimonials.Tables(0).Rows.Count - 1%>
            ...
            <div class="box-white">
                ...
                <a style='color:black;font-weight:normal;' href='Testimonialinfo.aspx?stid=<%= dsTestimonials.Tables(0).Rows(i)("stid").ToString() %>'>
                <div class="test-component">
                    ...
                    <article class="test-content">
                        ...
                        <%= dsTestimonials.Tables(0).Rows(i)("descTestimonial").ToString() %>
                        </p>
                    </article>
...
<%--<script src="js/vendor/jquery-1.9.1.min.js" type="text/javascript"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function openModalNews(id) {
            ...
            //$.ajax({
            //            type: "POST",
            //            url: "Default-new.aspx/NumberOfHit",
