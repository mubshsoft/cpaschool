...
input[type=checkbox], input[type=radio] {
    ...
    <h1 class="heading-color">Successfully Completed Course</h1> 
    <div class="breadcrumbs">
		<ul class="clearfix">
        <li><a href="../Admin/Adminlogin.aspx">Admin Panel</a></li>
<li><a href="ReportList.aspx">Report Panel</a></li>
       <li class="active">Successfully Completed Course Report</li>
		</ul>
	</div>
    </section>
    ...
    <asp:DropDownList ID="ddlCourse" runat="server" ToolTip="Course Title"  CssClass="form-control" AutoPostBack="True"
                                                                    OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged">
                                                                </asp:DropDownList>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
<asp:DropDownList ID="ddlbatch" runat="server" ToolTip="Batch Title"  CssClass="form-control" AutoPostBack="True"
