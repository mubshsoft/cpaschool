<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/HomeMaster-new.master" CodeFile="Calendar.aspx.cs" Inherits="Calendar" %>
...
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/css/bootstrap-datetimepicker.min.css" rel="stylesheet" />
   ...
   <style>body>section {
	...
	<h1 class="heading-color">Calendar</h1> 
    ...
    <section class="container main">
     ...
     <div class="row">&nbsp;</div>                                              
     <div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background:#fff; border-radius:10px; padding:2em">
             <span style="text-align:center;font-weight:bold;padding-top:5px;padding-bottom:5px;"> Event Calendar</span>
        <div id="calender"></div>
    ...
    <div class="modal-dialog">
     ...
     <div class="row-fluid"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                               
